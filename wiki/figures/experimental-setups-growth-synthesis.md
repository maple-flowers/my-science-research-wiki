...
### 8. 图5 CVD界面调制生长晶圆级单胞Cr₂S₃（AFM单层厚1.8 nm）

CVD界面调制生长晶圆级单胞Cr₂S₃（AFM单层厚1.8 nm）

![图：图5 CVD界面调制生长晶圆级单胞Cr₂S₃（AFM单层厚1.8 nm）](../../raw/figures/RecentAdvancesGrowth2025/fig_5_ATZ3HWYI.png)
*   **来源**：[[../papers/RecentAdvancesGrowth2025]]
