...
> 收录声子色散曲线、声子态密度、红外与拉曼活性分子/晶格振动模式相关的图表、数据表及物理公式。
> 共收录相关条目 **20** 个（图: 0, 表: 18, 公式: 2）。
...
- **元数据属性**:
  - **标签 (Tags)**: `#方法：有限元模拟`
  - **材料 (Materials)**: `TMDs及其变体（MoS2）`, `MoS2`
  - **方法 (Methods)**: `TEM`, `first-principles`, `Raman`
