...
![式2 Σ1 对称原子位移 δR=Σ_Q u cos(Q·R+φ) Q̂](../../raw/figures/Barnett2006coexistence/eq_2_2NLQ8BHX.png)
...
### 2. eq_1
![eq_1](../../raw/figures/CastroNeto2001charge/eq_1_DEPUZYQZ.png)
...
### 3. eq_2
![eq_2](../../raw/figures/CastroNeto2001charge/eq_2_ZS3EZMM3.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 4. eq_3
![eq_3](../../raw/figures/CastroNeto2001charge/eq_3_NP9B3NTQ.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 5. eq_4
![eq_4](../../raw/figures/CastroNeto2001charge/eq_4_V4FEX7ZQ.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 6. eq_5
![eq_5](../../raw/figures/CastroNeto2001charge/eq_5_EHHPEHVI.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 7. eq_6
![eq_6](../../raw/figures/CastroNeto2001charge/eq_6_AVZCH9NK.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 8. eq_7
![eq_7](../../raw/figures/CastroNeto2001charge/eq_7_M5Y9GEBU.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 9. eq_8
![eq_8](../../raw/figures/CastroNeto2001charge/eq_8_XTSE6ERP.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 10. eq_9
![eq_9](../../raw/figures/CastroNeto2001charge/eq_9_CQKXMTFR.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 11. eq_11
![eq_11](../../raw/figures/CastroNeto2001charge/eq_11_WN9L9ZFB.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。

### 12. eq_12
![eq_12](../../raw/figures/CastroNeto2001charge/eq_12_M84KTL8V.png)
*   **来源**：[[../papers/CastroNeto2001charge]]
*   **图示描述**：以上 11 个公式图片按论文推导顺序排列，构成从 f 波 CDW 微观模型到狄拉克电子、压电耦合、边缘费米液体自能、声子配对、量子临界点与 KT 超导转变的完整方程链；公式 (10) 为有限温序参量表达式，原始笔记未截图。
*   **关键特征**：(1) ImΣ = τ₀⁻¹ + αT + γ|ω|（τ₀⁻¹=27 meV, α=2.14, γ=0.212）在 |ω|<60 meV 成立；(2) 紧束缚矩阵元 g_λ(k,q) 证明 g(k,Q₁) 沿节线为零；(4) H_D = v_F k_⊥ σ_z + v_0 k_∥ σ_x 给出各向异性狄拉克色散 ε=±√(v_F²k_⊥²+v_0²k_∥²)；(6) H_C = κ∫Φ ΣΨ†Ψ 描述压电耦合；(11) |Δ_s(0,g)| = 4πv_F v_0(1/g_c − 1/g) 仅当 g>g_c=4π^{3/2}√(v_F v_0)/Λ 时非零，定义 QCP；(12) T_KT = πσ_s/(2m*) 中 σ_s ∝ |Δ_s(0,g)|² 给出 KT 转变。
...
![图5 RbV3Sb5与各类超导体的Uemura标度对比](../../raw/figures/Islam2025enhancement/fig_5_RT7FCE3Z.png)
*   **来源**：[[../papers/Islam2025enhancement]]
...
![图4 TaSe₂ 的 χ′′(q)（嵌套峰位于错误波矢）与 χ′(q)（弱峰位于正确 q_CDW）对比](../../raw/figures/Johannes2008fermi/fig_4_DDJ3N7RI.png)
...
![图7 CeTe₃ 的 χ′′(q) 最强峰在 q_nest 而 χ′(q) 最强峰在 q_CDW，二者解耦](../../raw/figures/Johannes2008fermi/fig_7_RUGZDKQS.png)
*   **来源**：[[../papers/Johannes2008fermi]]
...
![图4 轨道成分导致C4对称性破缺的费曼图](../../raw/figures/Kang2012dimer/fig_4_9JE6KANU.png)
...
![图5 PoDW与SDW共存时的电荷磁化率](../../raw/figures/Kang2012dimer/fig_5_UKZ7WVKS.png)
*   **来源**：[[../papers/Kang2012dimer]]
...
![图1 BdG 中无序/CDW/超导配对振幅的实空间分布，团簇与随机构型对比](../../raw/figures/Koley2020charge/fig_1_4WRCB6UJ.png)
...
![图2 Δ_CDW 与 Δ_SC 随无序强度 Vd 的演化（团簇 vs 随机）](../../raw/figures/Koley2020charge/fig_2_FKBHXYLS.png)
*   **来源**：[[../papers/Koley2020charge]]
...
![图3 不同 Q 矢下载流子密度调制 ξi 的 CDW 空间图案](../../raw/figures/Koley2020charge/fig_3_FXDQH4QY.png)
*   **来源**：[[../papers/Koley2020charge]]
...
![图6 DMFT 电阻率随温度变化（x=0 与 x=1）及 TaSeS 超导序参量的 BCS 拟合](../../raw/figures/Koley2020charge/fig_6_WAX2QD4C.png)
*   **来源**：[[../papers/Koley2020charge]]
...
![图6 2H-TaSe2的广义磁化率χ(q)](../../raw/figures/Laverock2005fermi/fig_6_NNR73I97.png)
...
![图2：(a)静态磁化率最大特征值在Q=(π/4,π/4)处主峰；(b-d)动态磁化率迹虚部随U增大在Q点软化](../../raw/figures/Makogon2012wave/fig_2_DZDKDGH8.png)
...
![M-H loops of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_5_7WVQ8K43.png)
...
![图2 (BEDT-TTF)₁.₅CuCl₂ 磁化率随温度变化，4–50 K 服从居里-外斯定律，50 K 以上偏离](../../raw/figures/Unknown2003charge/fig_2_UB562FUX.png)
...
![图2 极性金属研究时间线（1965 Anderson-Blount → 2013 LiOsO₃ → 2018 WTe₂）及奇异性质概览](../../raw/figures/bhowalPolarMetalsPrinciples2023b/fig_2_80A6D28C.png)
...
### 38. 图2 CDW模频率温度依赖性
![图2 CDW模频率温度依赖性](../../raw/figures/chowdhuryReviewTheoreticalComputational/fig_2_TCKUYQ2X.png)
...
### 39. 图7 维度依赖CDW统一相图
![图7 维度依赖CDW统一相图](../../raw/figures/chowdhuryReviewTheoreticalComputational/fig_7_NZSMJSXX.png)
*   **来源**：[[../papers/chowdhuryReviewTheoreticalComputational]]
...
### 40. 图4 ：![图4：GGA+DF 下各 CDW 构型的 Se-Se 键长斑块模式](../../raw/figures/cossuStackingChargedensityWaves2024/fig_4_Q3DQNIFN.png) -> [[../figures/mathematical-models-formulas|光学、输运与其他解析公式]]
![图4 ：![图4：GGA+DF 下各 CDW 构型的 Se-Se 键长斑块模式](../../raw/figures/cossuStackingChargedensityWaves2024/fig_4_Q3DQNIFN.png) -> [[../figures/mathematical-models-formulas|光学、输运与其他解析公式]]](../../raw/figures/cossuStackingChargedensityWaves2024/fig_4_Q3DQNIFN.png)
...
### 41. 图1 自旋波模式示意图
![图1 自旋波模式示意图](../../raw/figures/deSousa2008electrical/fig_1_MFP3ILKR.png)
...
![公式2 声子自能 Π_{qαβ}=(2/N)Σ g (f_{k+q,m}−f_{k,n})/(ε_{k+q,m}−ε_{k,n}) g*](../../raw/figures/hallEnvironmentalControlCharge/eq_2_2CGFLMXF.png)
...
![表2 BiMnO3含Bi 6s/6p的紧束缚参数](../../raw/figures/hillWhyAreThere2000a/tab_2_PN4ZSH3D.png)
*   **来源**：[[../papers/hillWhyAreThere2000a]]
...
![图4 考虑交换劈裂后的自旋分辨3d/4s态密度](../../raw/figures/hillWhyAreThere2000a/fig_4_EARW8FVH.png)
*   **来源**：[[../papers/hillWhyAreThere2000a]]
...
![图9 层极化自旋霍尔效应 (LP-SHE)、Berry 曲率、MoTe2/MoS2 应变调控](../../raw/figures/kaurRecentAdvancesTheoretical2025a/fig_9_AVZKMT9S.png)
...
![Fe/Co/Ni 块体晶格常数、体模量、磁矩对比（表V）](../../raw/figures/kresseUltrasoftPseudopotentialsProjector1999c/tab_4_Q4HQJ9DS.png)
...
![图2 电阻率巨热滞回线（>400 K）及CDW波矢在整个温区内不变](../../raw/figures/lvUnconventionalHystereticTransition2022/fig_2_IR4WWUA2.png)
...
![图3 CDW能隙Eg和一级衍射峰积分强度I_CDW的滞回行为，证明滞回源于序参量振幅变化](../../raw/figures/lvUnconventionalHystereticTransition2022/fig_3_6R9M3JH7.png)
*   **来源**：[[../papers/lvUnconventionalHystereticTransition2022]]
...
![图1 PAW加性缀加示意：(a)全空间平面波赝量，(b)减赝单中心项，(c)加全电子单中心项](../../raw/figures/shishkinImplementationPerformanceFrequencydependentGWmethod2006/fig_1_VIE5IKT4.png)
...
![图3 反（正）磁场线三维可视化与向下延拓得到的 σm：单极、反单极、偶极、四极磁荷分布](../../raw/figures/tanRevealingEmergentMagnetic2024/fig_200_PVG5Y5B7.png)
...
![图2 原子分辨 SOC 能量差、零场/1T 下自旋织构、±P 态斯格明子手性相反](../../raw/figures/wangTunableD0Topological2025b/fig_2_QZWY2VAA.png)
...
![图3 垂直/水平磁场下斯格明子与双半子的磁场及温度演化（0–150 K / 0–120 K）](../../raw/figures/wangTunableD0Topological2025b/fig_3_UYVUXL8I.png)
*   **来源**：[[../papers/wangTunableD0Topological2025b]]
...
![Mn 与 Hf 的轨道分辨磁各向异性能（图9）](../../raw/figures/wuNonvolatileSwitchableHalfmetallicity2024/fig_9_42AFRGJH.png)
*   **来源**：[[../papers/wuNonvolatileSwitchableHalfmetallicity2024]]
...
![图6 滑动铁电性机遇示意图：连接莫尔物理、多铁、自旋电子学、谷电子学、拓扑、超导、非线性霍尔、存储应用](../../raw/figures/wuSlidingFerroelectricity2D2021a/fig_6_J7QFEQ5R.png)
...
![图1 滑移多铁机制示意图：AA(AFM,无极化)→AB/BA(FM,反向铁电与谷极化)](../../raw/figures/xunCoexistingMagnetismFerroelectric2024/fig_1_UNCVPF48.png)
...
![图2 单层GdI₂晶体结构、ELF、声子谱及SOC能带（谷劈裂155.5 meV）](../../raw/figures/xunCoexistingMagnetismFerroelectric2024/fig_2_AGA9PAPG.png)
*   **来源**：[[../papers/xunCoexistingMagnetismFerroelectric2024]]
...
![图5 AA/AB/BA堆垛的自旋分辨能带与贝里曲率（谷极化翻转）](../../raw/figures/xunCoexistingMagnetismFerroelectric2024/fig_5_GWY2W8FP.png)
*   **来源**：[[../papers/xunCoexistingMagnetismFerroelectric2024]]
...
### 86. 表3
![表3](../../raw/figures/zahraCriticalAnalysisFerroelectric2025/tab_3_AJMB32HI.png)
...
### 87. 原子-轨道分辨 SOC 能量分析
![原子-轨道分辨 SOC 能量分析](../../raw/figures/zhangNonvolatileControlTopological2025/fig_2_Q7TYSSIJ.png)
...
### 88. 斯格明子与双半子电流驱动动力学
![斯格明子与双半子电流驱动动力学](../../raw/figures/zhangNonvolatileControlTopological2025/fig_6_ZU3NDFU8.png)
*   **来源**：[[../papers/zhangNonvolatileControlTopological2025]]
