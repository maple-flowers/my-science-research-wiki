---
tags: [concept, topological, defects, skyrmion, vortex]
category: [D02, Z01]
---

# 拓扑缺陷与拓扑极化/磁序 / Topological Defects in Ferroics

在铁电、铁磁、多铁及铁弹性体系中，由于序参数（极化 $P$、磁化 $M$ 或应变 $\eta$）空间连续旋转或对称性破缺，在局域空间形成的受拓扑不变量（如绕数 Winding Number、拓扑荷 Topological Charge）保护的稳定局域构型。拓扑缺陷不仅是物性演化的核心元素，更是超越传统二进制的拓扑电子学与自旋电子学基础。
...
- **极化拓扑结构与阻挫**：
  - [[../../raw/note/2016_Nahas_Frustration and Self_KEY-5LUMAGDE]]：Frustration and Self-Ordering of Topological Defects in Ferroelectrics — 铁电体中拓扑缺陷的阻挫与自组织。
  - [[../../raw/note/2023_Gong_Absence of critical_KEY-SV4QQ8W4]]：Absence of critical thickness for polar skyrmions with breaking the Kittel law — 极化斯天明无临界厚度限制。
  - [[../../raw/note/2022_Xu_Tunable ferroelectri_KEY-F5BEV3DW]]：Tunable ferroelectric topological defects on 2D topological surfaces — 2D 拓扑表面上可调控的铁电拓扑缺陷。
- **拓扑磁性与多铁器件**：
  - [[../../raw/note/2025_Zhang_Nonvolatile control_KEY-3XD6QXZ5]]：Nonvolatile control of topological magnetism in 2D CrInTe₃ — 二维材料中拓扑磁性的非挥发调控。
  - [[../../raw/note/2025_Han_Polar topological ma_KEY-BW6JSXCP]]：Polar topological materials and devices: Prospects and challenges — 极化拓扑材料与器件前景综述。
  - [[../../raw/note/2025_Wang_Tunable d0 topologic_KEY-M8QIGEEB]] / [[../../raw/note/2025_Wang_Tunable d0 topologic_KEY-NPALHA3B]]：单层 In₂NO₄ 中可调控的 $d^0$ 拓扑磁态与多铁性。
