---
tags: [concept, density-functional-theory, paw-method, pseudopotential, lapw, projector-functions, norm-conserving-pseudopotential, projector-augmented-wave, augmentation-charge]
...
本文档围绕 **frozen-core-approximation** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「frozen-core-approximation」，由多篇论文的证据共同支撑。
