---
tags: [concept, beam-shaping, two-photon-polymerization, computer-generated-hologram, bessel-beam, axicon]
...
一个直径3.5毫米、最大结构高度6.4微米、采用有机-无机混合光刻胶（FemtoBond 4B）并由双光子聚合技术制造的透射式衍射光学元件（DOE）。

## 👵 太奶导读

乖孙，这一条讲的是「一个直径3.5毫米、最大结构高度6.4微米、采用有机-无机混合光刻胶（FemtoBond 4B）并由双光子聚合技术制造的透射式衍射光学元件（DOE）」。
