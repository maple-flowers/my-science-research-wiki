...
*图 1：铁性序与空间/时间反演对称性。磁序（Time-reversal symmetry breaking）与电序（Spatial-inversion symmetry breaking）的共存是产生本征磁电耦合的前提（见 [[../../raw/note/RecentAdvancesGrowth2025|Recent Advances 2025]]）。*
...
*   **Ⅰ型多铁性 (Type-I)**：铁电性与磁性起源于不同子系统（如 BiFeO₃ 中的 Bi 6s² 孤对电子驱动铁电性，Fe 3d 电子驱动磁性）。此类材料通常具有较高的相变温度，但磁电耦合较弱，因为两个序参量之间缺乏直接的对称性关联（见 [[../../raw/note/spaldinRenaissanceMagnetoelectricMultiferroics2005|Spaldin 2005]]）。
*   **Ⅱ型多铁性 (Type-II)**：铁电性直接由特定的磁结构（如螺旋磁序）诱导产生。由于铁电序本身是磁序的派生量，其耦合系数极强，但受制于复杂的磁结构，转变温度往往极低（如 TbMnO₃，见 [[../../raw/note/fiebigEvolutionMultiferroics2016|Fiebig 2016]]）。

### 2. 应变介导耦合 (Strain-Mediated)
通过铁电/铁磁异质结界面处的晶格应变传递实现耦合。
*   **方案**：在衬底上外延生长铁电相（如 PZT）与铁磁相（如 CoFe₂O₄）的复合薄膜。
*   **优势**：室温磁电系数可比单相材料高出 2-3 个数量级，是薄膜存储器件的主流路线（见 [[../../raw/note/rameshMultiferroicsProgressProspects2007|Ramesh 2007]]）。
...
*   **典型案例**：**双层 CrTe₂**。实验证实其在室温大气环境下具有强健的多铁性，并实现了非易失性的“电写磁读”功能（见 [[../../raw/note/tianRoomtemperatureTwodimensionalMultiferroic2026|Tian 2026]]）。
...
在 2D 层状材料中，通过层间滑移（Sliding）或莫尔超晶格（Moiré）改变堆叠对称性，从而诱导极化并调控底层磁性（如 HgI₂ 或 In₂Se₃，见 [[../../raw/note/chenStrongSlidingFerroelectricity2024|Chen 2024]]）。
...
| 挑战维度 | 描述 | 相关文献 |
| :--- | :--- | :--- |
| **d0 约束** | 过渡金属 d 电子填充与铁电畸变（需 d0）的化学不相容性 | [[../../raw/note/spaldinRenaissanceMagnetoelectricMultiferroics2005|Spaldin 2005]] |
| **临界厚度** | 铁电性随厚度减小而消失的问题（HfO₂ 和 2D 材料已部分克服） | [[../../raw/note/spaldinAdvancesMagnetoelectricMultiferroics2019|Spaldin 2019]] |
| **金属铁电** | 在导电体系中维持静电极化的物理佯谬（面内金属性与面外绝缘性的解耦） | [[../../raw/note/tianRoomtemperatureTwodimensionalMultiferroic2026|Tian 2026]] |

![2D Multiferroics Outline](../../raw/figures/RecentAdvancesGrowth2025/fig_15_TMK8S5HG.png)
*图 4：二维多铁材料的应用路线图。涵盖磁电、压电与磁弹耦合的交叉应用（见 [[../../raw/note/RecentAdvancesGrowth2025|Recent Advances 2025]]）。*

## 相关概念
- [[../../raw/note/spaldinRenaissanceMagnetoelectricMultiferroics2005|d0 规则与文艺复兴]]
- [[../../raw/note/fiebigEvolutionMultiferroics2016|多铁性十年演变]]
- [[../../raw/note/tianRoomtemperatureTwodimensionalMultiferroic2026|室温二维多铁金属 CrTe₂]]
- [[../../raw/note/rameshMultiferroicsProgressProspects2007|薄膜与异质结进展]]
