---
tags: [concept, density-functional-theory, machine-learning-potential, molecular-dynamics, embedded-atom-method, pair-distribution-function, icosahedral-packing, dulong-petit-law]
title: pair-analysis
type: concept
status: stub
year: 2019
...
本文档围绕 **pair-analysis** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「pair-analysis」，由多篇论文的证据共同支撑。
