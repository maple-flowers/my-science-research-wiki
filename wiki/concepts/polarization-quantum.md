---
tags: [concept, berry-phase, berry-connection, modern-polarization-theory, wannier-function, born-effective-charge]
title: polarization-quantum
type: concept
status: developing
year: 1993
...
- **领域贡献**：为后续边界IP（现代极化理论）到达原始发初端点；提供了α标准处理方法；发表了现代实现对“自发极化极值算法”的评价基石（如现代铁电材料构型研究），同时引入相位几何的概念影响到拓扑物理。
