---
tags: [concept, ferroelectricity, polarization-switching, ferroelectric-tunnel-junction, neuromorphic-computing, in-memory-computing]
title: doping-engineering
type: concept
status: stub
year: 2026
...
乖孙，这一条要讲的核心对象是「重点综述了互补金属氧化物半导体兼容铪基铁电体（Hf-FEs）的材料体系、器件物理和性能指标，重点介绍了它们在下一代非易失性存储器中的应用潜力」。
这篇论文为它提供了关键证据。
...
- [[../concepts/fatigue-effect|fatigue-effect]]
