---
tags: [concept, density-functional-theory, enthalpy-of-formation, brillouin-zone-integration, gga-functional, numerical-atomic-orbitals, bader-analysis, charge-density, zero-flux-surface]
title: lattice-bias
type: concept
status: developing
year: 2000
papers: [Delley2000, tangGridbasedBaderAnalysis2009]
updated: 2026-08-18
---

# lattice-bias

本文档围绕 **lattice-bias** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「lattice-bias」，由多篇论文的证据共同支撑。
