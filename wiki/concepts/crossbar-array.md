---
tags: [concept, ferroelectricity, polarization-switching, ferroelectric-tunnel-junction, neuromorphic-computing, in-memory-computing, spin-orbit-coupling, magnetic-tunnel-junction, mlc-stt-ram]
...
本文档围绕 **crossbar-array** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「crossbar-array」，由多篇论文的证据共同支撑。
这篇论文为它提供了关键证据。
