---
tags: [concept, 2d-materials, strain-engineering, topological-defects, berry-phase, density-functional-theory]
title: ferroelectric-topological-defects
type: concept
status: developing
year: 2022
...
# ferroelectric-topological-defects
...
二维（2D）铅硫族化合物单层材料，即PbX (X=S, Se, Te)，特别是PbTe。

## 👵 太奶导读

乖孙，这一条讲的是「二维（2D）铅硫族化合物单层材料，即PbX (X=S, Se, Te)，特别是PbTe」。
...
- [[../concepts/paraelectric-ferroelectric-transition|paraelectric-ferroelectric-transition]]
- [[../concepts/polar-vortex|polar-vortex]]
- [[../concepts/antivortex|antivortex]]
- [[../concepts/flux-closure|flux-closure]]
- [[../concepts/polarization-phase-diagram|polarization-phase-diagram]]
- [[../concepts/giant-piezoelectricity|giant-piezoelectricity]]
- [[../concepts/multiscale-simulation|multiscale-simulation]]
