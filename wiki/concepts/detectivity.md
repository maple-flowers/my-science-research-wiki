---
tags: [concept, infrared-detection, band-pass-filter, photoconductivity, skin-depth, atmospheric-window]
title: detectivity
type: concept
status: developing
year: 1989
...
乖孙，这一条讲的是「采用MBE技术在KCl(100)衬底上生长的Pb₀.₈₂Sn₀.₁₈Te单晶薄膜，以及由其构成的干涉带通滤波器和光电导探测器」。
