---
tags: [concept, density-functional-theory, machine-learning-potential, conjugate-gradient-minimization, subspace-alignment, nose-thermostat]
title: born-oppenheimer-md
type: concept
status: stub
year: 1993
...
本文档围绕 **born-oppenheimer-md** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「born-oppenheimer-md」，由多篇论文的证据共同支撑。
