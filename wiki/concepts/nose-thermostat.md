---
tags: [concept, density-functional-theory, machine-learning-potential, conjugate-gradient-minimization, subspace-alignment]
title: nose-thermostat
type: concept
status: developing
year: 1993
...
本文档围绕 **nose-thermostat** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「nose-thermostat」，由多篇论文的证据共同支撑。
