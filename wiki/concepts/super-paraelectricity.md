...
## 二维莫尔结构中的机制
在二维范德华材料及其莫尔超晶格（Moiré Superlattices）中，超顺电性主要源于[[../papers/wuSlidingFerroelectricity2D2021a|滑动铁电性 (Sliding Ferroelectricity)]] 的动力学特性。
...
## 典型材料与实验发现
### 双层扭转 h-BN
在 [[../papers/heUltrafastSwitchingDynamics2024|He et al. (2024)]] 的研究中：
...
### 其他候选体系
- **3R 相 TMDs**：如 3R-MoS₂，利用其本征非中心对称性结合滑动机制实现极化开关（参见 [[../papers/sunSlidingFerroelectricityTwodimensional2025|Sun et al. (2025) 综述]]）。
...
## 本库相关
- [[../papers/heUltrafastSwitchingDynamics2024]]（h-BN 莫尔超顺电实验证据）
- [[../papers/wuSlidingFerroelectricity2D2021a]]（滑动铁电机制探讨）
- [[../papers/sunSlidingFerroelectricityTwodimensional2025]]（2D 滑动铁电综述）
