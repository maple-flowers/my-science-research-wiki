---
tags: [concept, 2D-materials, ferroelasticity, magnetoelectric-coupling, multiferroicity, polarization-switching]
title: intercalation-engineering
type: concept
status: developing
year: 2025
...
文章的研究对象是二维范德华多铁材料，即那些在原子级厚度下展现出两种或以上铁性序的层状材料。

## 👵 太奶导读

乖孙，这一条讲的是「文章的研究对象是二维范德华多铁材料，即那些在原子级厚度下展现出两种或以上铁性序的层状材料」。
