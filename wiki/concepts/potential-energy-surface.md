---
tags: [concept, nudged-elastic-band, climbing-image-neb, minimum-energy-path, saddle-point, transition-state-theory, domain-walls, topological-defects, weyl-semimetal, higher-order-topology, polar-metal]
title: potential-energy-surface
type: concept
status: stub
year: 2000
papers: [henkelmanClimbingImageNudged2000c, huangPolarPhaseDomain2019]
updated: 2026-08-18
---
...
本文档围绕 **potential-energy-surface** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「potential-energy-surface」，由多篇论文的证据共同支撑。
