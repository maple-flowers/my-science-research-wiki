...
type: entity
status: developing
papers: ['Blessing2026optical', 'Mińkowski2021cation', 'Srinivasan1989lead', 'aminiAtomicscaleVisualizationMultiferroicity2024', 'bhowalPolarMetalsPrinciples2023b', 'chenStrongSlidingFerroelectricity2024', 'cuiIntercorrelatedInplaneOutofplane2018a', 'dingPredictionIntrinsicTwodimensional2017a', 'fengFerroelectricityMultiferroicityTwodimensional2020', 'gaoStrainEngineeringFerroelectric2024', 'guanRecentProgressTwoDimensional2020', 'guoAdvancesTwodimensionalFerroelectric2025', 'huProgressProspectsLowdimensional2019', 'huangTwodimensionalIn2Se3Rising2022', 'junqueraCriticalThicknessFerroelectricity2003', 'kaurRecentAdvancesTheoretical2025a', 'kresseInitiomolecularDynamicsLiquid1993', 'laiTwodimensionalFerromagnetismDriven2019', 'liPhaseTransitions2D2021', 'martinThinfilmFerroelectricMaterials2016', 'shenEmergenceMultipleFerroelectric2025', 'sunSlidingFerroelectricityTwodimensional2025', 'tangCombiningIntrinsicSlidinginduced2025', 'wuNonvolatileSwitchableHalfmetallicity2024', 'wuSlidingFerroelectricity2D2021a', 'xuTwodimensionalFerroelasticityVan2021', 'yangRipplingFerroicPhase2021', 'zhangEmergingFrontiersTwodimensional2025']
updated: 2026-08-18
---

# SnTe

SnTe 是**岩盐结构的铁电/拓扑窄带隙半导体**：晶格畸变产生局域极化（铁电性）、电子结构具拓扑表面态（拓扑晶体绝缘体），并可能呈现铁电超导与极性金属行为。SnTe 是研究铁电-拓扑耦合、Rashba 物理与二维铁电的典型材料（本库 SnTe 相关论文核心对象）。

## 👵 太奶导读

太奶啊，SnTe 是一种"身兼多职"的窄带隙半导体：它的晶格稍微"歪"一点就冒出铁电（能记住电方向）、它的表面藏着拓扑保护的导电态（拓扑晶体绝缘体）、低温还可能超导。一块材料把"铁电+拓扑+超导"攒齐了，科学家盯着它研究这些性质怎么互相"搅和"，是物性交叉的明星样品。

## 🧩 核心内容与机制 (Core Content)

- **结构与铁电**：岩盐结构，软模驱动极性畸变，居里温度约 100 K 量级（本库 SnTe 铁电论文）。
- **拓扑晶体绝缘体**：镜像对称保护的拓扑表面态（本库 SnTe 拓扑论文），可与铁电极化耦合调控。
- **Rashba 与自旋**：反演破缺（inversion-symmetry-breaking）产生 Rashba 自旋劈裂（本库 SnTe 自旋物理论文）。
- **超导与极性金属**：掺铟等可实现超导与极性金属（polar-metal）行为（本库 SnTe 超导论文）。
- **二维 SnTe**：薄层 SnTe 铁电与拓扑共存（本库二维 SnTe 论文）。

## 🔗 关联概念与实体 (Related Concepts & Entities)

- [[../concepts/ferroelectricity|铁电性]]：SnTe 的极化畸变。
- [[../concepts/topological-insulator|拓扑绝缘体]]：SnTe 的拓扑表面态。
- [[../concepts/lone-pair-electrons|孤对电子]]：Sn 5s² 驱动的畸变。
- [[../concepts/spin-orbit-coupling|自旋轨道耦合]]：SnTe 的 Rashba 物理。
