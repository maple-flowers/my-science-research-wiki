...
乖孙，这“硫磷化镍”就像是材料界里的“变色龙”。
它虽然也是反铁磁，但它的脾气比前两个亲戚更古怪。它里头的小磁针既不像卫兵那样站死，也不像溜冰手那样躺平，而是在这两个状态之间反复横跳（XXZ 模型）。
最神的是，当它的磁性发生变化时，它的透光性也会跟着大变样。科学家们想用它来做那种能“看见磁性”的特殊镜头，或者用它来研究那些只有在最顶尖的实验室里才能见到的量子奇观。
...
| 性质 | 数值 | 备注 |
| :--- | :--- | :--- |
| **尼尔温度 ($T_N$)** | ~155 K | 家族中转变温度较高者 |
| **磁各向异性** | XXZ 型 | 介于易轴与易面之间 |
| **禁带宽度** | ~1.8 eV | 具有明显的激子吸收峰 |
...
- [[../concepts/neel-temperature|尼尔温度]]（相变临界）
- [[../concepts/exchange-bias|交换偏置]]（常用于异质结锁定）
- [[../entities/MnPSe3|MnPSe₃]] / [[../entities/FePS3|FePS₃]]（同族对比）
- [[../entities/TMDs|TMDs]]（常用的功能集成底材）
