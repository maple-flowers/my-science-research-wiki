---
tags: [entity, density-functional-theory, machine-learning-potential, molecular-dynamics, embedded-atom-method, pair-distribution-function, pair-analysis, icosahedral-packing, dulong-petit-law]
title: Ti
type: entity
status: developing
year: 2019
...
本文档围绕 **Ti** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「Ti」，由多篇论文的证据共同支撑。
