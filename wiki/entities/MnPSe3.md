...
乖孙，这“硒磷化锰”就像是材料界里的“太极高手”。
它虽然也是个小磁铁，但它里头的小箭头是“成对儿”对着站的（反铁磁），所以从外面看它一点儿磁性都不显，低调得很。
它的磁性箭头最喜欢在大平层（面内）里活动，像是在溜冰场上滑行。虽然它不吸东西，但科学家能用激光或者电流去敲打它的节奏（自旋波），用来传信息又快又稳，还没啥杂音。
...
| :--- | :--- | :--- |
| **尼尔温度 ($T_N$)** | ~74 K | 需低温实验 |
| **磁各向异性** | 易面 (Easy-plane) | XY 模型典型材料 |
| **禁带宽度** | ~2.3 eV | 透明绝缘体，利于光学探测 |
| **磁结构** | 海森堡型反铁磁 | 自旋在面内几乎各向同性 |
...
- [[../concepts/easy-plane|易磁化面]]（磁各向异性特征）
- [[../entities/FePS3|FePS₃]]（同族垂直易轴对比材料）
- [[../entities/NiPS3|NiPS₃]]（同族强关联效应代表）
