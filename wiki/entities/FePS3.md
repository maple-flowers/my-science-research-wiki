...
好孩子，如果说刚才那个 MnPSe₃ 是个喜欢“横着走”的溜冰手，那这“硫磷化铁”就是个“站得笔直”的卫兵。
哪怕把它减薄到只有一层原子，里头的小磁针也必须一根根竖着站，不是朝天就是接地，绝不斜着眼看人。这种“非此即彼”的性格（伊辛型），让它存起信号来特别干脆利索，是科学家研究纳米级磁性开关的一块“宝地”。
...
| 性质 | 数值 | 备注 |
| :--- | :--- | :--- |
| **尼尔温度 ($T_N$)** | ~118 K | 二维极限下仍维持较高转变温度 |
| **磁各向异性** | 垂直易轴 (Ising-type) | PMA 极强 |
| **禁带宽度** | ~1.6 eV | 宽带隙半导体/绝缘体 |
...
- [[../concepts/magnetic-anisotropy|磁各向异性]]（伊辛行为之源）
- [[../concepts/easy-axis|易轴]]（面外指向）
- [[../entities/MnPSe3|MnPSe₃]]（易面型对照组）
- [[../entities/NiPS3|NiPS₃]]（XXZ 模型对照组）
