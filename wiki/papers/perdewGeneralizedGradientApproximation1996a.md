...
## 📊 关键图表
  - 图1：PBE 与 PW91 增强因子 F_XC 随无量纲密度梯度 s 的对比，ζ=0 与 ζ=1 两种自旋极化情形 ![图1 增强因子对比](../../raw/figures/perdewGeneralizedGradientApproximation1996a/fig_1_JDC9MYFC.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - 表I：20 个小分子原子化能，UHF/LSD/PW91/PBE 与实验值对比，平均绝对误差分别为 71.2/31.4/8.0/7.9 kcal/mol ![表I 原子化能](../../raw/figures/perdewGeneralizedGradientApproximation1996a/tab_1_GMJNJVEU.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - 公式(7)：关联能梯度修正项 H 的解析形式 ![eq7 H函数](../../raw/figures/perdewGeneralizedGradientApproximation1996a/eq_7_KUPYSBIE.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - 公式(14)：交换增强因子 F_X(s)=1+κ−κ/(1+μs²/κ) ![eq14 Fx](../../raw/figures/perdewGeneralizedGradientApproximation1996a/eq_14_6VZ3PA5A.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
## 🔬 项目连接
