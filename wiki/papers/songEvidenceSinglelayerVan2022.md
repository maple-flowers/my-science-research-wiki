...
## 📊 关键图表
  ...
  ![ED Fig.1 NiI2 晶体的 X 射线与电子衍射](../../raw/figures/songEvidenceSinglelayerVan2022/fig_1_GZQKY2GB.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - 图2 — 块体 NiI₂ 中 Domain I–III 的偏振显微图、双折射诱导偏振旋转 θ(T) 与线性二色性 ΔR(T) 对比、三畴角分辨 ΔR(θ)，显示局域 C₂ 轴。
  ![ED Fig.2 块体 NiI2 线性二色性与双折射偏振旋转](../../raw/figures/songEvidenceSinglelayerVan2022/fig_2_CKHGZI78.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - 图3 — 波长依赖 RA-SHG：826 nm 需 ED+MD 共同拟合，991 nm 仅 ED 分量，确立 991 nm 为纯电偶极 SHG 探测波长；PVD 样品与 CVT 一致。
  ![ED Fig.3 NiI2 波长依赖二次谐波产生](../../raw/figures/songEvidenceSinglelayerVan2022/fig_3_ZTPW73ZE.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - 图4 — 块体 NiI₂ 30–300 K 变温 XY 偏振拉曼、XX/XY 通道对比，以及 30 K 下 Domain I/II 的 σ⁺/σ⁻ 圆偏振拉曼与净 ROA。
  ![ED Fig.4 块体 NiI2 变温偏振拉曼光谱](../../raw/figures/songEvidenceSinglelayerVan2022/fig_4_8NRPR6W3.png) -> [[../figures/vibrational-spectra|振动能谱与声子谱]]
  - 图5 — XY 构型角分辨偏振拉曼（ARPRS）：31、37 cm⁻¹ 模式极坐标图符合电磁振子；80 cm⁻¹ 峰在 T_N,2 以下分裂为 79.9/80.2 cm⁻¹ 两声子；120.8/168.8 cm⁻¹ 为磁振子。
  ![ED Fig.5 角分辨偏振拉曼 ARPRS](../../raw/figures/songEvidenceSinglelayerVan2022/fig_5_SVSUQPWV.png) -> [[../figures/vibrational-spectra|振动能谱与声子谱]]
  - 图6 — 块体 NiI₂ 体光伏效应（BPE）器件：PVD 薄片桥接蓝宝石间隙上的 Au 电极；30 K 多铁相零偏光电流显著增强，外加 1 T 磁场使光电流增加 10–15%（磁电耦合证据）。
  ![ED Fig.6 块体 NiI2 体光伏效应](../../raw/figures/songEvidenceSinglelayerVan2022/fig_6_9VZVGC5P.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - 图7 — 块体、1 层、2 层 NiI₂ 的交叉偏振图像及温度依赖偏振对比度直方图；单层畴织构约 20 K 消失、2 层约 35 K 消失，与偏振旋转测量一致。
  ![ED Fig.7 块体/1层/2层 NiI2 交叉偏振图像](../../raw/figures/songEvidenceSinglelayerVan2022/fig_7_DFMYEJSV.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - 图8 — 单层 NiI₂ 晶体温度依赖 SHG 成像（780 nm 与 991 nm 激发）；三个单层晶体积分 SHG 计数在约 20 K 出现转变，与偏振旋转结果一致；存在温度无关的 NiI₂/hBN 界面残余 SHG。
  ![ED Fig.8 单层 NiI2 温度依赖 SHG 成像](../../raw/figures/songEvidenceSinglelayerVan2022/fig_8_WKNSHMS2.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - 图9 — 2 层、3 层 NiI₂ XY 构型变温拉曼；约 38 cm⁻¹ 软模分别在 25 K、35 K 以下建立，与偏振旋转和 SHG 所得转变温度一致。
  ![ED Fig.9 2层/3层 NiI2 变温拉曼软模](../../raw/figures/songEvidenceSinglelayerVan2022/fig_9_VF7LAEDU.png) -> [[../figures/vibrational-spectra|振动能谱与声子谱]]
  - 图10 — 1–4 层 NiI₂ 宽场光学图、对应 AFM 图，以及不同畴区的温度依赖偏振旋转测量，补充层数依赖的 T_c 数据。
  ![ED Fig.10 少层 NiI2 AFM 与额外偏振旋转测量](../../raw/figures/songEvidenceSinglelayerVan2022/fig_10_7P9LSDK9.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
## 🔬 项目连接
