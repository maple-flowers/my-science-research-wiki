...
- **元数据**：Atsushi Yarai, Takuji Nakanishi，2005，IEICE Electronics Express，Vol.2 No.14 pp.417-422，DOI 10.1587/elex.2.417
- **一句话**：首次将热透镜（TL）泵浦-探测光谱技术引入光纤湿度传感，用两根端面间距 <50 μm 的球透镜光纤构成微腔传感头，在泵浦功率 <100 mW 下实现了无需对光纤包层做任何化学处理的湿度测量，并证明传感器本质上测量的是绝对湿度。
- **现有wiki双链**：
