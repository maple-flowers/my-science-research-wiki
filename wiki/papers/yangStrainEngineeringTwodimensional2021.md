---
citekey: yangStrainEngineeringTwodimensional2021
title: "Strain engineering of <scp>two‐dimensional</scp> materials: Methods, properties, and applications"
title_zh: "二维材料的应变工程：方法、性质和应用"
authors: [Shengxue Yang, Yujia Chen, Chengbao Jiang]
year: 2021
journal: "InfoMat"
doi: "10.1002/inf2.12177"
url: "https://doi.org/10.1002/inf2.12177"
paper_type: review
status: ingested
year_read: 2026
...
figures: [crystal-structures, electronic-bands, electronic-devices, experimental-setups, heterostructures-stacking, mathematical-models, vibrational-spectra]
领域基础知识:: >-
  二维（2D）材料，如石墨烯和过渡金属硫族化合物（TMDs），因其原子级厚度而具有优异的力学、光学和电学性能。应变工程（Strain Engineering）是一种通过有意施加机械变形来改变材料晶格结构，进而调控其电子能带和物理性质的核心策略，对发展柔性电子器件至关重要。
研究背景:: >-
  传统的半导体应变工程受限于块体材料的脆性，应变幅度小。二维材料具有超强的弹性变形能力，对应变高度敏感，为应变工程开辟了广阔空间。然而，如何系统、可控地对二维材料施加应变，并理解应变与各种物理性质之间的内在关联，是推动其应用的关键。
作者的问题意识:: >-
  虽然二维材料的应变工程研究已取得大量成果，但缺乏一个从方法学、性质调控到器件应用的系统性梳理。本文旨在对现有应变引入方法进行分类和比较，系统总结应变对二维材料多种物理性质的调控机制，并展示其在柔性器件中的应用前景，最后指出面临的挑战和未来方向。
主要研究对象:: >-
  以石墨烯、MoS₂、WS₂、WSe₂、MoTe₂、黑磷(BP)等为代表的各类二维材料，及其在应变下的物理性质与器件应用。
主要研究方法:: >-
  本文为综述，系统归纳了六种主要的应变引入方法：1. 晶格失配；2. 利用柔性基底（弹性模量失配、热膨胀失配、机械弯曲）；3. 采用图案化基底；4. 使用压电基底；5. AFM探针尖加载；6. 气泡法。同时，涵盖了应变监测与表征技术，如拉曼光谱、光致发光(PL)谱、二次/三次谐波产生(SHG/THG)等。
研究意义:: >-
  本综述为二维材料应变工程领域提供了一个清晰、全面的知识框架。它不仅帮助研究者快速理解不同应变技术的原理和优劣，也系统梳理了应变调控材料性能的物理机制，为设计新型高性能柔性电子/光电子器件提供了理论指导与实践参考，指明了未来亟待突破的方向。
研究结论:: >-
  应变工程是调控二维材料性能的有效手段，可实现对其光学（带隙、光子模式）、电学（载流子迁移率、压阻/压电效应）、磁学及晶体结构相变的全方位调控。基于这些效应，高性能的柔性应变传感器和光探测器已被成功制备。然而，实现界面应变高效传递、缩小理论与实验差距、以及提升器件集成稳定性，仍是该领域应用转化的关键瓶颈。
对领域的贡献:: >-
  1. 建立了基于物理机制的应变引入方法分类体系，清晰对比了不同方法的优劣。2. 构建了“方法-性质-应用”的完整逻辑链条，提升了该领域知识的系统性。3. 明确指出界面应变传递效率和器件集成稳定性是未来商业化面临的核心挑战，为后续研究指明了方向。
未来研究方向提及:: >-
  文中明确提及的未来方向包括：1. 深入研究二维材料与基底间的界面力学行为（粘附、摩擦）。2. 探索更高效的应变引入新方法（如聚合物封装法）。3. 攻克应变调控磁性的实验难题，实现其在自旋电子学中的应用。4. 改进柔性器件集成工艺，解决电极脱落问题，提升器件稳定性。
未来研究方向思考:: >-
  1. 建立定量的普适界面应变传递模型，以预测与优化不同材料体系的应变传递效率。2. 探索二维材料在动态应变下的响应特性，如粘弹性和高频响应，拓展其在声学传感器和振动监测等领域的应用。3. 研究应变与电场、光场、温度等多场耦合的非线性新效应，设计多功能耦合器件。4. 发展晶圆级、可控、均匀的应变引入技术，解决从实验室原型到规模化生产面临的制造一致性和良率问题。
tags:
  - paper
  - type/review
  - year/2021
...
## 📊 关键图表
  - ![图1 柔性基底应变引入法：预拉伸褶皱、热失配、热收缩、弯曲装置](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_1_YWVERIAZ.png) → [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：该图系统对比了柔性衬底的三种物理机制（模量失配、热膨胀失配、机械弯曲），是全文"方法篇"的核心示意。
  - ![图2 图案化基底（波纹SiO₂、倒置漏斗Si、ZnO纳米棒）与PMN-PT压电基底](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_2_R4K6RUL3.png) -> [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：图案化衬底可把二维材料"锁定"在恒定局域应变态便于后续研究，压电衬底则提供电压精确调控的新维度，两者共同扩展了应变工程的可控性。
  - ![图3 AFM针尖压缩/拉伸加载、界面自发气泡与压力差鼓泡装置](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_3_82C33UVQ.png) → [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：AFM 针尖与气泡法分别代表"主动纳米压痕"与"被动界面现象"两条局域应变路径，是研究纳米尺度应变效应和连续梯度应变的理想平台。
  - ![图4 应变对声子（石墨烯G峰分裂、MoS₂ E'峰分裂）与能带（WSe₂间接-直接带隙转变、漏斗效应）的调控](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_4_KDFATFZY.png) → [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：该图从声子（拉曼）和电子（PL）两个维度建立了"应变—光谱指纹"对应关系，是无损伤、空间分辨应变表征的方法学基础。
  - ![图5 应变对电学性质的影响：褶皱MoS₂迁移率提升、粗糙SiNx基底、BP压阻效应、单层MoS₂压电效应](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_5_8GRJM49G.png) -> [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  - **图示描述**：(A)(B) 褶皱与平坦 MoS₂ FET 转移特性对比；(C)(D) 粗糙 c-SiNx 与平坦 SiO₂ 衬底上 MoS₂ FET 性能对比；(E)–(G) 柔性 PEN 衬底上黑磷 FET 在拉伸/压缩应变下的电阻响应；(H) 单层 MoS₂ 在拉伸/释放时由压电效应产生极化电荷、驱动外电路电子流动的示意。
  - **关键特征**：30 K 下褶皱 MoS₂ 迁移率 5.55 cm²/Vs，约为平坦器件 1.42 cm²/Vs 的 3 倍，归因于拉伸应变抑制电子-声子耦合；BP 在 +0.15% 拉伸、−0.18% 压缩下电荷中性点附近电阻剧变，机制为带隙增减的压阻效应；仅奇数层（1/3/5 层）MoS₂ 破缺中心对称呈现压电效应，偶数层无响应，可主动调制肖特基势垒。
  - **结论/意义**：该图区分了迁移率提升（本征能带效应）、压阻（被动、需外电）和压电（主动、可自驱动）三种电输运响应，为柔性传感器与纳米发电机选型提供依据。
  - ![图6 应变诱导磁性（NbS₂/NbSe₂、褶皱ReSe₂）与2H-1T'相变（AFM驱动MoTe₂电导率变化10⁴倍）](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_6_D9X8L38L.png) → [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：把应变工程的调控边界从光、电性质拓展到磁序和结构相变，展示了在自旋电子学和相变存储中的应用潜力，也暴露了磁性调控实验瓶颈。
  - ![图7 柔性应变传感器：石墨烯GF~151、片层滑移变阻机制、人体运动监测、MoS₂触觉阵列](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_7_759Q4J7C.png) -> [[../figures/heterostructures-stacking-mechanics-misc|力学性质、剥离能与杂项]]
  ...
  - **结论/意义**：该图把压阻原理与可穿戴/电子皮肤应用直接对接，是"方法→物性→器件"逻辑链在传感器方向的落点。
  - ![图8 柔性光电探测器：褶皱石墨烯增强光吸收、单层MoS₂压电光电子效应调控肖特基势垒](../../raw/figures/yangStrainEngineeringTwodimensional2021/fig_8_ZEAZ8UJ9.png) → [[../figures/heterostructures-stacking-spintronics-strain|自旋电子学与应变工程]]
  ...
  - **结论/意义**：该图说明应变工程不仅能做传感器，还能通过"光吸收+载流子分离"双路径提升光电探测器响应度，连接了力学、光电子和压电物理。
  - ![表1 六种应变诱导方法在各二维材料体系中的应变范围与类型对比](../../raw/figures/yangStrainEngineeringTwodimensional2021/tab_1_QX9M44VW.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  ...
  - **结论/意义**：这是全文方法学的"速查手册"，把六大类方法的适用材料、应变幅度和应变状态浓缩在一张表中，是综述方法分类贡献的集中体现。
  - ![公式1 预应变定义 εpre=ΔL/L×100%](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_1_TAWJDU8R.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![公式2 褶皱顶部最大应变 ε=π²hδ(1−σ²)/λ²](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_2_MVDKLZED.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![公式3 弯曲基底应变 ε=τ/(2R)；AFM针尖局部应变 ε=F/(AE)](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_3_HMFU6L9E.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![公式4 气泡高宽比 h/R=√(πγ/(5C₁Y))](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_4_GCHGJJJ9.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - **图示描述**：范德华界面自发气泡形貌参数（高度 h、半径 R）的力学平衡关系。
  - **关键特征**：h/R=√(πγ/(5C₁Y))，原文式 (4)；γ 为二维材料对衬底的粘附能，C₁ 为数值系数，Y 为二维材料杨氏模量；气泡高宽比仅由材料/衬底力学参数决定，与气泡个体尺寸无关，可用来反推界面粘附能。
  - ![公式5 气泡局部应变 ε∝(h/R)²](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_5_MPIIV52Z.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - **图示描述**：包围自发气泡的单层二维材料薄膜局部应变与气泡高宽比的标度关系。
  - **关键特征**：ε∝(h/R)²，原文式 (5)；MoS₂/h-BN 界面自发气泡由此可引入约 2% 的平滑梯度应变；应变随气泡顶点距离平滑变化，是研究连续梯度应变和激子漂移的天然平台。
  - ![公式6 悬浮膜中心应变 ε=σ(ν)(δ/a)²](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_6_PSPYJIMK.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![公式7 应变修正二阶非线性极化率张量 χ⁽²⁾ᵢⱼₖ=χ⁽²,⁰⁾ᵢⱼₖ+Pᵢⱼₖₗₘuₗₘ](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_7_23JKPS6N.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![公式8（原文编号续）配套非线性光学/力学关系](../../raw/figures/yangStrainEngineeringTwodimensional2021/eq_8_6QU4TXB3.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
