...
## ✏️ 可写入 Wiki 的要点
  ...
  8. [[../concepts/bloch-spin-wave|布洛赫自旋波]]（基于 Slater 对 N-1 平行+1 反平行态的严格解，低 k 密度下叠加）给出低温律 M=Np[1-A(kT/J)^(3/2)]，简单立方 A=0.1174；并证明平面六方晶格即使在绝对零度也不铁磁，T^(3/2) 律得 Fallot 等实验支持。
