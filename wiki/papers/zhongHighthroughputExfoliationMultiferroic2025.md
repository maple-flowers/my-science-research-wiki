...
## ✏️ 可写入 Wiki 的要点
  ...
  6. **相锁定的三种电子响应**：(i) 能带边排序改变；(ii) [[../concepts/fermi-surfaces|费米面]]自旋极化态重构；(iii) 带隙可调的半导体-金属互变。SrOsO₃ P4mm(AFM, Rashba 劈裂)↔P4bm([[../concepts/altermagnetism|交变磁性]] altermagnetism，自旋简并)：P4bm 引入 OsO₅ 五面体绕 c 轴面内旋转（Glazer a⁰a⁰c⁰ 型），破缺 P4mm 中的面内自旋时间反演 Tτ 与[[../concepts/spin-flop|自旋翻转]]反演 Uτ；SrIrO₃ Pc(AFM，自旋上/下带隙 1.14/1.35 eV)→P4bm(FM [[../concepts/half-metal|半金属]]，自旋下通道金属、自旋上带隙扩至 3.58 eV)；SrMoO₃ P4mm(AFM，0.186/0.196 eV)→Pc(自旋下金属、自旋上 0.304 eV)；后两者费米面自旋极化率达 100%。
