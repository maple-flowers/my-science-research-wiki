...
## 📊 关键图表
  - **图1：初始构建的Si(001)平板模型**
  - ![图1 初始构建的Si(001)平板模型（3×3和6×6单胞，3原子层，265 Å真空层）](../../raw/figures/Wu2018/fig_1_VL4JLVHG.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **图2：p(2×2)重构表面原子结构**
  - ![图2 p(2×2)重构表面原子结构（Zigzag不对称二聚体，键长2.30/2.60 Å，翘曲角8.30°/9.81°）](../../raw/figures/Wu2018/fig_2_REWLZVN8.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **图3：c(4×2)重构表面原子结构**
  - ![图3 c(4×2)重构表面原子结构（反铁电式翘曲排列，翘曲角10.36°，部分二聚体翘曲方向无序）](../../raw/figures/Wu2018/fig_3_CXK2HJNT.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图4 p(2×2)和c(4×2)表面Mulliken电荷布居等高线图（上翘原子得电荷>4.00，下陷原子失电荷<4.00；p(2×2)呈带状，c(4×2)呈块状）](../../raw/figures/Wu2018/fig_4_448UV8HK.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图5 Ge原子在Si二聚体上的6个初始吸附位置示意图（Top_SiA/B/D/C、Bridge_Si(A-B)/(C-D)，h=1.2–5.4 Å）](../../raw/figures/Wu2018/fig_5_5S2TAJJS.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **图6：吸附能随初始高度h变化曲线**
  - ![图6 吸附能随初始高度h变化曲线（p(2×2)最高约5.6 eV，c(4×2)最高约4.8 eV，多峰谷波动）](../../raw/figures/Wu2018/fig_6_KFPGS48H.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **图7：18种稳定Ge吸附几何构型**
  - ![图7 18种稳定Ge吸附几何构型（顶位/桥位/偏心桥位）](../../raw/figures/Wu2018/fig_7_ZMMHBDT2.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图8 Ge原子与二聚体局部Mulliken电荷布居（Ge布居2.57–3.11，总是失电荷）](../../raw/figures/Wu2018/fig_8_3389MDG6.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图9 整个表面Mulliken电荷分布全局图](../../raw/figures/Wu2018/fig_9_KRFUWFLH.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **表1：重构表面二聚体键长与翘曲角**
  - ![表1 重构表面二聚体键长与翘曲角（与DFT和实验值对比）](../../raw/figures/Wu2018/tab_1_EJMQ6AWK.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **表2：未重构与重构表面总能量及表面能**
  - ![表2 未重构与重构表面总能量及表面能（重构降低表面能0.0458/0.0469 eV/Å²）](../../raw/figures/Wu2018/tab_2_3TJTUIDV.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **表3：Ge原子稳定吸附构型参数汇总**
  - ![表3 Ge原子稳定吸附构型参数汇总（初始高度、吸附能、键长、翘曲角、布居数）](../../raw/figures/Wu2018/tab_3_J24H28UA.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - **公式1：吸附能定义**
  - ![公式1 吸附能定义 Eads = Etot(Sislab) + E(Ge) − Etot(Ge/Sislab)](../../raw/figures/Wu2018/eq_1_JGIRGE42.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
