...
6. **关键器件指标**：3R-MoS₂ FeFET 存储窗口约 7 V，耐久 >10⁴ 次、保持特性良好；写脉冲可短至 53 ns，[[../concepts/domain-wall-motion|畴壁运动]]速度最高约 300 μm/s；MoS₂/WS₂ 异质双层 FTJ 的 ON/OFF ~10³；[[../entitys/graphene|石墨烯]]/h-BN 莫尔突触器件功耗低至约 20 pW，可实现 LTP/LTD 与模式识别。
