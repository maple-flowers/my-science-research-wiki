...
"作者的问题意识": >-
  尽管滑动铁电性领域发展迅猛，但相关研究分散，缺乏一个系统性的总结。作者旨在撰写一篇全面综述，以澄清滑动铁电性的基本物理图像，梳理其从材料制备、表征到器件应用的全链条进展，并明确指出当前面临的挑战和未来发展方向，为研究者提供一个系统的知识框架和路线图。
"主要研究对象": >-
...
- **元数据**：Xiaoyao Sun、Qian Xia、Tengfei Cao、Shuoguo Yuan 等，2025，*Materials Science and Engineering: R: Reports*，vol. 163，100927，DOI [10.1016/j.mser.2025.100927](https://doi.org/10.1016/j.mser.2025.100927)。
- **一句话**：这是一篇 2025 年的长篇综述，系统梳理了二维范德华材料中由层间相对滑移产生面外极化的"滑动铁电性"——三种构建路径（3R 菱方堆叠、扭转角、莫尔超晶格）、材料谱系、制备表征工具箱以及 FeFET/FTJ/突触/光伏存储器等器件应用，是当前该领域最完整的知识框架之一。
...
- `concepts/interlayer-charge-transfer.md` — 层间电荷转移，滑动铁电极化的微观来源；伴随轨道重叠、费米能级劈裂与载流子屏蔽退极化场。
- `concepts/stacking-engineering.md` — 堆叠工程，通过控制 AA/AB/ABC/3R 等堆叠构型调控对称性与极化，区别于扭转角工程。
...
- `concepts/depolarization-field.md` — 退极化场，二维极限下传统铁电消失的主因，而滑动 FE 由载流子/电极屏蔽。
...
- `concepts/valley-polarization.md`、`concepts/chiral-phonons.md`、`concepts/flat-band.md` — 莫尔/多层滑动 FE 衍生的能带与拓扑物理。
- 实体建议：`entities/MoS2.md`、`entities/WSe2.md`、`entities/WS2.md`、`entities/GaSe.md`、`entities/InSe.md`、`entities/MoSi2N4.md`、`entities/CrI3.md`、`entities/GdI2.md`、`entities/VSe2.md`、`entities/Cr2Ge2Te6.md`、`entities/graphene.md`、`entities/MnSe.md`、`entities/ReS2.md`、`entities/Cd3Cl6.md`、`entities/Janus-MoSSe.md`。
...
- Fig. 1 二维滑动铁电材料与器件应用总览（FTJ、FeFET、光伏器件、突触器件）。
  ![Fig.1 二维滑动铁电材料与器件应用总览](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_1_IP9FMC6N.png)
- Fig. 2 滑动铁电材料发展时间线（2017 理论预测—2020 h-BN/石墨烯结构观测—2021 h-BN 表面极化—后续器件验证）。
  ![Fig.2 滑动铁电发展时间线](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_2_668MSTBJ.png)
- Fig. 3 三种铁电机制对比：(a) ABO₃ 钙钛矿离子位移；(b) 二维本征铁电（α-In₂Se₃）；(c) 滑动铁电（h-BN）。
  ![Fig.3 钙钛矿/本征2D/滑动三种铁电机制对比](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_3_MJ4XCXMR.png)
- Fig. 4 三种构建滑动 FE 的路径：(a) 双层间莫尔超晶格（石墨烯旋转）；(b) 3R 非中心对称堆叠层间滑移；(c) 双层间扭转。
  ![Fig.4 三种构建滑动铁电的途径](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_4_NPRDG4HD.png)
- Fig. 5 (a) MoS₂ 的 3R 与 2H（镜面对称）原子结构；(b) 3R 菱方堆叠的晶格弛豫与极化；(c–d) 扭转双层/三层石墨烯中的莫尔条纹超晶格及层间滑移、畴演化。
  ![Fig.5 3R/2H结构与莫尔条纹弛豫](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_5_WCYVSJFZ.png)
- Fig. 6 (a–b) CVD 制备 MoS₂（硫粉+MoO₃，Ar 保护气）；(c–d) UV 胶带剥离/转移铜网上石墨烯。
  ![Fig.6 CVD制备与UV胶带转移](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_6_VIW6WRL3.png)
...
- Fig. 8 (a) 4D-STEM 暗场成像；(b) 扭转角减小过程中非铁电—铁电转变时畴壁运动的实时观测；(c) MoSSe 扭转角产生 Se–Se 构象对应的滑动；(d) 扭转堆叠产生的波纹结构示意。
  ![Fig.8 4D-STEM与扭转堆叠畴壁动力学](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_8_TCTNIAM4.png)
- Fig. 9 (a) 石墨烯/h-BN 扭转超晶格 vdW 器件；(b) 转移曲线迟滞；(c) Bernal 堆叠双层石墨烯晶格；(d) 石墨烯扭转形成超晶格的双层器件；(e) 石墨烯器件电阻特性。
  ![Fig.9 石墨烯/h-BN扭转超晶格器件](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_9_PQXND8EP.png)
- Fig. 10 (a) h-BN 堆叠类型；(b) 各类型不同偏压态 I–V 曲线；(c–d) 外加电场下 h-BN 畴演化；(e) 层间差分电荷密度；(f) r-BN z 轴极化；(g) 不同温度 PFM 信号指示居里温度；(h) 不同偏压下 PFM 振幅/相位回线。
  ![Fig.10 h-BN/r-BN堆叠、电学与PFM表征](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_10_GMTK9YT3.png)
- Fig. 11 (a) 不同层数下电场—漏极电流关系；(b) 三层 WTe₂ 电场—电导关系；(c) 3R-MoS₂ 双栅器件示意；(d) 双栅控制与 3R-MoS₂ 原子堆叠；(e–f) WSe₂ 等器件。
  ![Fig.11 不同层数与双栅3R-MoS2/WSe2器件](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_11_347LFPW8.png)
- Fig. 12 MX 结构与器件：(a) AA/AC 堆叠与层间滑移诱导极化；(b) 器件示意；(c) GaSe 纳米片 SS-PFM；(d) SHG 信号强度与偏振角依赖。
  ![Fig.12 MX（GaSe等）堆叠、SS-PFM与SHG](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_12_HWWZSN8Y.png)
- Fig. 13 (a) 3R-MoS₂ 沟道 FeFET 示意；(b) 原子级铁电极化翻转；(c) 编程/擦除性能；(d) 堆叠 3R-MoS₂ FET 转移特性（约 7 V 存储窗口）。
  ![Fig.13 3R-MoS2 FeFET结构与转移特性](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_13_XSTYQFRU.png)
...
- Fig. 15 (a) 石墨烯/h-BN 异质结双栅沟道突触器件；(b) 顶面莫尔周期势将电荷局域化实现电子横向流动；(c) 输入图样训练；(d) 两个输出神经元对输入图样的响应训练；功耗低至 ~20 pW。
  ![Fig.15 石墨烯/h-BN莫尔突触器件](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_15_RDRJFJNV.png)
...
- Fig. 17 (a) 双栅实现逻辑器件示意；(b–c) 用双层/三层 MoSi₂N₄ 替代沟道材料构建滑动铁电逻辑器件，实现极化行为。
  ![Fig.17 MoSi2N4滑动铁电逻辑器件](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_17_UFUDD9CJ.png)
- Fig. 18 (a) 人工突触晶体管 LTP/LTD 阈值（4 V 脉冲，底栅 0–1 V）；(b) 生物突触与自适应行为（含"眼睑"自适应示意）；(c) 双向突触阈值滑动，阈值 θₘ 可调（m=1,2,3,…）。
  ![Fig.18 自适应人工突触与双向阈值滑动](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/fig_18_E5IUKUJH.png)
- Table 1 钙钛矿铁电、铪基铁电、典型二维本征铁电与滑动铁电的优缺点对比（退极化场、疲劳、CMOS 兼容性、极化值）。
  ![Table 1 四类铁电材料优缺点对比](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/tab_1_N6IMKLEB.png)
...
- Table 3 层间扭转角与铁电性的对应关系（石墨烯、MoS₂/graphene、h-BN/graphene、Tl₂S、h-BN、WSe₂、MoS₂、MoSe₂、WS₂；角度、相结构、层数、表征证据）。
  ![Table 3 扭转角—铁电性对应关系](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/tab_3_2VHVRALU.png)
- Eq. 1 垂直电场下滑动双层的哈密顿量：含共轭动量 π̂ₛ = ρₛ ûₛ、弹性常数 λ、μ 等，是 Landau/连续介质描述层间滑移自由度的核心方程。
  ![Eq.1 滑动双层在垂直电场下的哈密顿量](../../raw/figures/sunSlidingFerroelectricityTwodimensional2025/eq_1_KY8JAUNW.png)
