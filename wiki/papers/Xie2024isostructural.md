...
## 📊 关键图表
笔记未附图片（raw/figures/Xie2024isostructural/ 目录下仅有 manifest.json，无图片文件）。原文关键图包括：Fig.1 同构掺杂策略示意与分子结构；Fig.2 光物理性质对比（衰减曲线、TRES映射、PL/ML光谱）；Fig.3 机理解析（TD-DFT空穴-电子分布、偶极矩、Hirshfeld表面、RPhos、Jablonski图）；Fig.4 普适性验证（多主体多客体体系）；Fig.5 器件应用（光学存储、压力显示、应力监测）。
