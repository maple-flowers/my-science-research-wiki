...
## 📊 关键图表
笔记未附图片（raw/figures/Huang2023two/ 下仅有 manifest.json，含 Table 1、Table S18 等表格抽取，无图）。正文关键图：Fig.1a 1a 在 10 种溶剂中的归一化单光子发射光谱；Fig.1b 发射波数与 Δf/π*/δΔG≠/ET(30)/Z 的线性相关；Fig.2c–f 甘油-乙醇粘度依赖与甘油中变温的单/双光子发射谱，其中 Fig.2d 首次显示双光子三重荧光（A/B/E 带，E 带位于 542 nm）。
