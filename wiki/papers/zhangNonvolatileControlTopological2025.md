---
citekey: zhangNonvolatileControlTopological2025
title: "Nonvolatile control of topological magnetism in two-dimensional CrInTe2/In2Se3 multiferroic heterostructures"
authors: [Shuo Zhang, Yunfei Zhang, Dan Xing, Lixiu Guan, Junguang Tao]
year: 2025
journal: "Materials Today Chemistry"
doi: "10.1016/j.mtchem.2025.103049"
url: "https://doi.org/10.1016/j.mtchem.2025.103049"
paper_type: theory
status: ingested
year_read: 2026
...
tags:
  ...
  - concept/magnetic-anisotropy-energy
  - concept/heisenberg-exchange
  - concept/rashba-effect
  - concept/spin-transfer-torque
  - concept/skyrmion-hall-effect
  - concept/topological-charge
  - concept/llg-equation
  - concept/micromagnetic-simulation
  - concept/racetrack-memory
  ...
  - method/llg
  - method/spin-spiral
  - method/spin-transfer-torque
  - method/thiele-equation
  - material/CrInTe2
  - material/In2Se3
  - material/CrInTe2-In2Se3
  - topic/multiferroics
  - topic/2d-materials
  - topic/skyrmions
  - topic/spintronics
...
- **关键图表**：
  ...
  - 图3 P↓ 态拓扑磁织构静态相图：50 mT 即可擦除 P↑ 态斯格明子，P↓ 态 SkX 可维持至 Bz = 5.2 T，200 K、4.4 T 下密度仍 >628 μm⁻²：
    ![拓扑磁结构相图与温度稳定性](../../raw/figures/zhangNonvolatileControlTopological2025/fig_3_Z9FGHBYU.png)
  - 图4 K 值对拓扑相及各能量项（E_Ani、E_DMI、E_Ex、E_Zeeman）的调控：K > 2.0 meV/Cr 稳定孤立斯格明子，K < −2.0 meV/Cr 稳定双半子：
    ![MAE 对拓扑相与能量的影响](../../raw/figures/zhangNonvolatileControlTopological2025/fig_4_TV6K5X9T.png)
  - 图5 d∥–K 全局相图与无量纲判据 κ：|κ| < 5 为斯格明子-迷宫混合相，5 < |κ| < 10 为孤立斯格明子/双半子窗口：
    ![d-K 相图与 κ 判据](../../raw/figures/zhangNonvolatileControlTopological2025/fig_5_SCSIXLYM.png)
  ...
  - 表1 两种极化态下磁学参数对比（J、K、d∥ 随极化翻转的变化）：
    ![磁学参数表](../../raw/figures/zhangNonvolatileControlTopological2025/tab_1_DUDZIDX5.png)
  - 关键方程（LLG 方程、自旋转移矩强度 u、拓扑荷 Q、自旋哈密顿量、Thiele 方程）：
    ![方程1 LLG](../../raw/figures/zhangNonvolatileControlTopological2025/eq_1_VFQJF82Y.png)
    ![方程3 拓扑荷](../../raw/figures/zhangNonvolatileControlTopological2025/eq_3_4IHDA4XH.png)
...
- **可写入wiki的要点**：
  ...
  4. **微观机制**：差分电荷密度显示 P↓ 态 Se→In 电荷转移强于 P↑，界面 Rashba 型 SOC 放大；Te 原子主导 MAE（P↑ 时 ΔE_SOC-MAE = 4.47 meV、P↓ 时 4.03 meV，本征仅 1.22 meV），Te2 主导 DMI；极化翻转使 Te1 对 DMI 的原子分辨 SOC 贡献由 −8.81 meV 反转为 +3.20 meV，是 DMI 净增强的直接来源。Te2 的 p_x–p_y 杂化对 MAE 负贡献、p_z–p_x/p_y 杂化正贡献，极化翻转使 p_x–p_y 负贡献更负。
  5. **键角与超交换**：θ1 在 P↑/P↓ 下为 90.15°/90.64°，θ2 为 94.25°/94.32°（本征 90.03°、94.12°），偏离 90° 削弱 Cr–Te–Cr 超交换路径，导致 J 下降，符合 GKA 规则。
  6. **静态拓扑相图**：0 K 下 P↑ 态在 50 mT 时 SkX 坍塌为 FM；P↓ 态 SkX 可维持至 Bz = 5.2 T，|Q| 在 Bz ≈ 2.8 T 达到峰值 17，5.6 T 完全进入 FM；斯格明子半径 R_x 由 0 T 的 6.15 nm 压缩至 5.2 T 的 2.86 nm。温度上 P↓ 态 SkX 在 200 K、4.4 T 下密度仍 >628 μm⁻²，优于 CrSeI/In2Te3；200 K 以上转入 FD，再升温进入 PM。
  7. **κ 判据**：κ = (π/4)²·2JK/(3d∥²)（AI 解读中写作 (π²/4)·2JK/(3d∥²)，原式以 (π/4)² 给出）量化共线能量（J、K）与非共线能量（d∥）的竞争。|κ| < 5 → 斯格明子-迷宫混合（SLM）相；5 < |κ| < 10 → 孤立斯格明子/双半子稳定窗口；|κ| 更大 → FM 相。该判据可作为筛选二维 vdW 多铁异质结的"配方"。
  ...
  9. **电流驱动动力学**：u = 0.6 μeV（对应 j = 4.14×10⁹ A/m²）下斯格明子 v_x = 3.25 m/s、v_y = 0.67 m/s，霍尔角 11.68°；双半子 v_x = 2.71 m/s、v_y = 0.12 m/s，霍尔角 2.44°（小约 80%）。物理根源是斯格明子耗散张量各向同性（d_xx = d_yy = d，tan θ = G/(αd)），双半子耗散张量各向异性（d_xx ≠ d_yy，tan θ = G/(αd_xx)），故横向漂移被抑制；v_x 斯格明子约为双半子 1.2 倍，v_y 差异可达 5.5 倍。
  10. **器件意义与局限**：该异质结把"电场可调拓扑 + 电流驱动动力学"集成于同一材料平台，双半子适合密集存储阵列、斯格明子横向运动可用于逻辑分流，对应赛道存储器/神经形态计算；但工作温度 200 K 仍低于室温，且理论预测尚待机械剥离+vdW 组装实验以及 MOKE/LTEM 等磁成像验证，GGA+U 中 U 值敏感性、长程 DMI、结构弛豫与纯电子效应的拆分等是可进一步检验的点。
