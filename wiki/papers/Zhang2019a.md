...
## 📊 关键图表
  - ![EAM总势能公式 Eq.1](../../raw/figures/Zhang2019a/eq_1_JKSLE4FW.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![广义元素对势 Eq.3](../../raw/figures/Zhang2019a/eq_3_IY4F7YGW.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![电子密度函数 Eq.4](../../raw/figures/Zhang2019a/eq_4_LZSYGSBF.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![嵌入能分段公式 Eq.5–7](../../raw/figures/Zhang2019a/eq_5_AKZ9ZC4I.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![嵌入能分段公式 Eq.6](../../raw/figures/Zhang2019a/eq_6_3NZCI3TL.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![嵌入能分段公式 Eq.7](../../raw/figures/Zhang2019a/eq_7_WN3PU9VD.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![对分布函数公式 Eq.9](../../raw/figures/Zhang2019a/eq_9_KF8MDN7A.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图1 Ti135/Ti257/Ti895弛豫过程每原子能量随时间步变化](../../raw/figures/Zhang2019a/fig_1_8GSJRYRQ.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图2 1421/1422/1441/1661原子对示意图](../../raw/figures/Zhang2019a/fig_2_34UVRTQI.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - ![图3 小尺寸粒子平均能量-温度曲线](../../raw/figures/Zhang2019a/fig_3_VVXJNDWX.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图4 Ti135/Ti257/Ti895不同温度PDF与原子堆积快照](../../raw/figures/Zhang2019a/fig_4_SK6TQB88.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  - ![图5 熔化温度随粒子直径变化（<4 nm振荡，>4 nm收敛）](../../raw/figures/Zhang2019a/fig_5_UJHJUH45.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  - ![图6 大尺寸粒子（Ti1099–Ti3455）能量-温度曲线](../../raw/figures/Zhang2019a/fig_6_T7VXXEFK.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图7 六粒子1421/1422原子对数量随温度变化](../../raw/figures/Zhang2019a/fig_7_TQ8EAVTC.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图8 ΔEav/ΔT斜率随原子数N变化（杜隆-珀蒂1.5kB边界）](../../raw/figures/Zhang2019a/fig_8_2H6SNMFM.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![图9 Ti1099/Ti2361/Ti3347不同温度原子堆积（表面预熔可视化）](../../raw/figures/Zhang2019a/fig_9_JRFEECJM.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  - ![表1 EAM势参数](../../raw/figures/Zhang2019a/tab_1_GBW2JGJ2.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
