...
## ✏️ 可写入 Wiki 的要点
  ...
  4. **最佳掺杂浓度**：ML 峰值强度在 Eu = 0.1 mol% 时最大；更低时发光中心不足，更高时因相邻 Eu³⁺ 间非辐射能量迁移到猝灭中心而发生浓度猝灭。
  ...
  9. **异价掺杂增强缺陷**：RE³⁺ 取代 Ba²⁺ 造成价态失配，增加了缺陷中心的形成概率，这是稀土掺杂钒酸盐中 ML 出现的结构性原因。
  10. **局限与后续**：作者未做 EPR/XPS/TL 等直接缺陷鉴定，也未给出量子效率或陷阱深度；606 nm 峰归属、空穴陷阱本质、ML 动力学衰减等仍需高分辨光谱 + EPR + 热释光联用实验来验证。该材料因剂量灵敏度低，更适合作为机理性样例而非高灵敏度剂量计。
