...
## 📊 关键图表
  - 图1 模型构建：石墨烯→(5,0)纯碳管→氮层替换碳层形成竹节状 N-CNT
    ![模型构建示意图](../../raw/figures/Wei2021/fig_1_UIMKRHUI.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  ...
  - 图2 12 种 (n=3–14,0) 竹节状 N-CNT 的 SCC-DFTB 优化结构（侧视+俯视），紫色 N 环明显内缩
    ![优化结构](../../raw/figures/Wei2021/fig_2_HEFEACEL.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 图3 (a) C/N 环直径差；(b) C/N 环横截面积比，均呈奇偶振荡
    ![直径差与面积比](../../raw/figures/Wei2021/fig_3_HZFN27FK.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 图4 四个键角（C-C-N、C-N-N、C-C-C、N-N-N）随手性指数变化
    ![键角变化](../../raw/figures/Wei2021/fig_4_JANH5U8W.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 图5 (a)(b) 纯 CNT 与 N-CNT 本征能；(c) 能隙；(d) 化学势
    ![能量与电子性质](../../raw/figures/Wei2021/fig_5_DGNGSS8K.png) -> [[../figures/electronic-bands|电子能带与电子态]]
  ...
  - 图6 纯 CNT 中 C、N-CNT 中 C/N/全部原子的 Mülliken 布居最大-最小差值
    ![Mülliken布居差](../../raw/figures/Wei2021/fig_6_HH7C2QLX.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 图7 一个碳环-氮环重复单元内各原子 Mülliken 电荷的颜色编码可视化
    ![Mülliken布居可视化](../../raw/figures/Wei2021/fig_7_UNPG39BZ.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 表1 锯齿型 (n,0) CNT 与竹节状 N-CNT 的几何参数（原子数、键长、环直径）
    ![几何参数表](../../raw/figures/Wei2021/tab_1_6LUL9Z5F.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
