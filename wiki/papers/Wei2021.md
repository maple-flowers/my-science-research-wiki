...
projects: [project-4]
concepts: [density-functional-theory, dftb, nitrogen-doping, mulliken-population, odd-even-oscillation, curvature-effect, charge-transfer, chemical-potential, sp2-sp3-hybridization, DFTB+]
...
## 🔗 Wiki 双链
  ...
  - 概念 [[../concepts/chemical-potential]]、[[../concepts/sp2-sp3-hybridization]]、[[../concepts/dftb]]
  - 实体 [[../entities/bamboo-like-N-CNTs]]、[[../entities/carbon-nanotubes]]、[[../entities/DFTB+]]
  - 相关论文 [[../../raw/note/Wei2021]]
## 🆕 新概念/实体建议
  - [[../entities/carbon-nanotubes|carbon-nanotubes]]（entity）：碳纳米管（CNTs），由石墨烯卷成的一维纳米材料，按手性 (n,m) 分类。
  - [[../BOTH/bamboo-like-N-CNTs|bamboo-like-N-CNTs]]（entity）：竹节状氮掺杂碳纳米管，氮在节点富集、内部隔室化的特殊形貌。
  - [[../BOTH/DFTB+|DFTB+]]（entity）：德国不来梅大学开发的 SCC-DFTB 计算软件包。
## 📊 关键图表
