...
- **可写入wiki的要点**：
  ...
  4. **应变的双重作用**：第一性原理表明孤对电子型 BiFeO₃ 的极化对应变相当不敏感（深势阱、大离子位移、高 T_C），因此想靠应变显著调极化需用更"软"、接近铁电失稳的铁电体；但应变若改变晶体对称性则影响显著——BiFeO₃ 在 [100] SrTiO₃ 衬底上由菱方降为单斜，六重简并的易磁化面解除，反铁磁轴择优沿 [1–10]，使 109° 极化翻转（而非 71° 翻转）伴随反铁磁轴重定向，从而调控磁电开关行为。
  5. **三种薄膜架构**：(a) 单相外延薄膜——以 BiFeO₃、YMnO₃ 为代表，外延应变与晶体化学是控制变量；(b) 水平多层异质结——原子级层状堆叠在界面设计多铁性；(c) 垂直异质结——磁性尖晶石纳米柱（CoFe₂O₄、NiFe₂O₄、Fe₃O₄）外延嵌入钙钛矿铁电基体（BaTiO₃、PbTiO₃、BiFeO₃、SrTiO₃），三维异质外延、界面面积大、衬底夹持弱。
  6. **垂直异质结的电控磁实验**：在 BiFeO₃–CoFe₂O₄ 自组装纳米柱中，2 T 预磁化后所有纳米柱磁化同向（MFM 亮色）；对中心方区施加 16 V 直流电场叠加 ~700 Oe 偏置磁场后，该区纳米柱磁化全部翻转（暗色）；纳米柱矫顽场约 3 kOe。耦合由两晶格间强机械耦合介导，调制磁各向异性；时间反演对称要求必须叠加一个弱外磁场才能实现确定性翻转。开放问题包括耦合时间尺度、最小翻转磁场、化学/尺寸依赖、临界尺寸与长程有序组装。
  ...
  8. **测量方法**：经典 ∂P/∂H 或 ∂M/∂E 直接测量在薄膜中常因漏电和寄生效应失败，信号仅纳伏级需锁相检测。替代手段包括 PEEM（XMCD-PEEM 探铁磁畴、线性二色性 PEEM 探反铁磁畴，分辨率 20–50 nm，PEEM 3 可达 10 nm；Scholl 等已用于 Co/LaFeO₃ 交换偏置成像）、电场调制 MOKE、以及铁磁/反铁磁共振谱（微波/毫米波频段，最接近实际应用）。原位沉积-同步辐射表征一体化（图3）是新兴方向。
  9. **两条电控磁路径与器件蓝图**：(i) 电控自旋倾斜——倾斜由 Dzyaloshinskii–Moriya 相互作用产生，典型角 ~0.5°、弱铁磁剩磁 1–10 emu/cm³；BiFeO₃ 中自旋倾斜耦合于 FeO₆ 八面体反铁畸变旋转而非铁电畸变，故 180° 极化翻转不改变磁态，但非 180°（71°/109°）翻转可重定向反铁磁矢量；BaNiF₄ 计算上演示了弱反铁磁性的电场翻转；关键开放问题是能否把倾斜角提高一个数量级。(ii) 电控交换偏置——以铁电反铁磁体（如 BiFeO₃）钉扎相邻铁磁层（Co、CoFe₂O₄、NiFe₂O₄），电场翻转 FE 极化即重定向 AFM 轴，再经交换偏置翻转 FM 磁化，实现非易失、低功耗自旋电子学写入。
  10. **多铁隧道结与自旋波器件**：多铁隧道结以 1–2 nm（数个晶胞）厚多铁体（如 BiMnO₃）为势垒，因其电子态自旋极化而充当自旋过滤器，又因铁电而可电场调制势垒高度，构成电、磁双控四态电阻器件；难点在于超薄外延膜结构质量、磁/铁电序参量在该厚度的稳定性（铁电临界厚度仅数个晶胞且强依赖电极屏蔽，磁有序影响尚不明）。更远景为电控自旋波器件：Smolenskii & Chupis (1982) 理论提出交变电场激发自旋波、磁场激发铁电振荡，可做磁电发生器/自旋波放大器；Pimenov 等 (2006) 在多铁锰氧化物中首次观察到电磁振子（electromagnons）混合激发。
