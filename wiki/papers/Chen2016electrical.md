...
doi: "10.1038/srep19092"
url: "https://doi.org/10.1038/srep19092"
...
tags:
  ...
  - concept/ferroelectric-domain
  - concept/domain-wall-motion
  - concept/coercive-field
  - concept/ferroelectric-photovoltaic-effect
  - concept/depletion-layer
  - concept/nondestructive-readout
  - concept/two-step-switching
  - entity/BiFeO3
  - entity/domain-wall
  - entity/SrTiO3
  - entity/La0.67Sr0.33MnO3
  - entity/BaTiO3
  - entity/PbZrxTi1-xO3
  - entity/ITO
  - entity/PLD
  ...
  - method/pfm
  - method/c-afm
  - method/photovoltaic-measurement
  - method/phase-field
  - material/BiFeO3
  - material/SrTiO3
  - material/La0.67Sr0.33MnO3
  - material/BaTiO3
  - material/PbZr0.2Ti0.8O3
  - material/ITO
  - topic/multiferroics
  - topic/ferroelectricity
  - topic/domain-walls
  - topic/flexoelectricity
  - topic/ferroelectric-memory
---
...
- **关键图表**：
  ...
  - 图2 电学翻转畴演化：−1.8 V 畴壁成核 → −2 V 分解为纳米畴（棕色，>94% 翻转）→ −2.3 V 重组为 μm 级 P−3/P−4 畴，标注 A–F 各区域两步翻转路径
    ![Fig.2 电学翻转的成核-分解-重组过程](../../raw/figures/Chen2016electrical/fig_2_8M5UCVB2.png)
  - 图3 力学翻转定量演化：1×1 μm² 区域内随力 140→700→1050→1400→1750→3325 nN，向下畴面积比由 0→8.9%→41.4%→82.2%→95.9%→100%；加压前后表面均光滑无塑性损伤
    ![Fig.3 力学翻转面积比随针尖力递增至100%](../../raw/figures/Chen2016electrical/fig_3_V2QYGQGG.png)
  - 图4 力学翻转畴演化细节：875 nN 畴壁成核 → 1050 nN 分解为纳米畴 → 1330 nN 重组为 μm 畴（G、H、I、J、K 区域路径），与图2高度平行
    ![Fig.4 力学翻转与电学翻转相似的畴演化](../../raw/figures/Chen2016electrical/fig_4_I3MJA2P9.png)
...
- **可写入wiki的要点**：
  ...
  4. 180° 极化翻转几乎不直接发生，而是通过两步铁弹翻转完成：典型路径 P1→P−1（71°）→P−3（109°）或 P1→P−2（109°）→P−3（71°）；71°/109° 翻转同时改变极化方向和晶格畸变方向，是 BiFeO3 中实现磁电耦合的物理基础（180° 纯铁电翻转不改变易磁化面）。
  5. 初始畴为 6 V 极化后的 P2–P3/P3–P4/P4–P1 条纹畴；P1–P2 应变与 P−3–P−4 应变匹配，因此重组后的向下畴倾向占据原 P1/P2 位置。
  6. 无损读出方案一（c-AFM）：1 V 偏压（远低于 Vc=2.3 V）下，向下极化使 p-LSMO/n-BiFeO3 界面耗尽层变窄、漏电流增大；向上极化耗尽层展宽、电流减小，电流差异可区分两态。
  7. 无损读出方案二（光伏）：300 μm ITO 顶电极、~100 mW/cm² 可见光照射下，短路电流 Isc 方向与极化方向反向绑定——向下极化 Isc≈+20 nA，向上极化 Isc≈−30 nA；11 次光照开关循环无衰减，证明保持性与稳定性。
  8. 样品制备：PLD 在 630 °C、16 Pa O2 下生长 ~70 nm BiFeO3 和 ~70 nm LSMO，KrF 激光 248 nm/1 Hz/60 mJ；630 °C、1000 Pa O2 退火 30 min 以减少氧空位，再以 5 °C/min 冷却至 300 °C。
  9. 作者指出衬底外延应变和界面内建电场可能对力学翻转阈值/路径有重要贡献；在 LaAlO3 衬底上具有 MPB 的 >50 nm BiFeO3 薄膜中，电场/力还可触发四方—菱方相变，提示力学翻转可与相变耦合产生更大机电响应。
