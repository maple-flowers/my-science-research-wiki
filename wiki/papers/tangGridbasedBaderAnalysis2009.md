...
concepts: [density-functional-theory, bader-analysis, charge-density, zero-flux-surface, lattice-bias, steepest-ascent, mulliken-population, electron-localization-function, non-nuclear-attractor, steepest-ascent-path, correction-vector, paw-method]
entities: [VASP, Gaussian-98, Quantum-ESPRESSO, Vanderbilt-ultrasoft, bader-code]
