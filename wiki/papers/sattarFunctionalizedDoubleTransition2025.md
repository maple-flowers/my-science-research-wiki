...
## 📊 关键图表
笔记未附图片（raw/figures 下仅 manifest.json，无图像文件）。原文图序经勘误更正：图 4 为 PFM（形貌+OOP/IP 相位），图 5 为 P-E 回线，图 6 为介电蝴蝶曲线与漏电流；图 7 为器件 I-V 与 Log I-Log V 拟合，图 8 为耐久/保持，图 9 为导电细丝模型。
