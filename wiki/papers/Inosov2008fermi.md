...
## 📊 关键图表
笔记未附图片（raw/figures/Inosov2008fermi/ 下仅有 manifest.json，无图像文件）。论文原图要点：图1 为 2H-TaSe₂ 在 290/180/107 K 下的 Lindhard 函数二维分布、高对称线剖面、费米面轮廓温度演化及 Rossnagel 模型对照；图2 为 TaSe₂/NbSe₂/Cu₀.₂NbS₂ 三材料的 ARPES 费米面、χ₀(q) 分布、剖面线与嵌套几何示意；表1、表2 给出三材料两能带各自 5 个紧束缚参数（eV）。
