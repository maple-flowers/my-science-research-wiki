...
concepts:
  - concepts/embedded-atom-method.md
  - concepts/molecular-dynamics.md
  - concepts/pair-analysis.md
  - concepts/icosahedral-packing.md
  - concepts/dulong-petit-law.md
  - concepts/cluster-size-effect.md
  - concepts/surface-premelting.md
  - concepts/sommerfeld-potential.md
  - concepts/additive-manufacturing.md
entities:
  - entities/Ti.md
