...
"主要研究方法": >-
  本文是一篇综述，综合运用了多种研究方法论。理论方面，包括基于密度泛函理论（DFT）的第一性原理计算、热力学和动力学分析、晶体场理论等。实验方面，涵盖了扫描隧道显微镜（STM）、原子力显微镜（AFM）、透射电子显微镜（TEM）、磁光克尔效应（MOKE）测量、静电栅压调控、激光诱导调控、化学气相沉积（CVD）生长等。
"研究意义": >-
...
- **元数据**：Wenbin Li、Xiaofeng Qian、Ju Li，2021，*Nature Reviews Materials* 6, 829–846，DOI: [10.1038/s41578-021-00304-0](https://doi.org/10.1038/s41578-021-00304-0)（综述）。
- **一句话**：以"短程化学键—长程静电/弹性相互作用—空间可及性"三维框架系统梳理二维材料中的扩散型、位移型与量子相变，把多晶型相变、铁性（铁弹/铁电/铁磁）相变与高温扩散相变统一到"相变工程"范式下，并连接到原型器件。
...
- **现有wiki双链**：
  ...
  - 图表 [[../figures/crystal-structures]]、[[../figures/electronic-devices]]、[[../figures/heterostructures-stacking]]、[[../figures/experimental-setups]]
  - 年度 [[../write/2021]]
