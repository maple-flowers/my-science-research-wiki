...
## 📊 关键图表
  - 图1 XRD 图谱（菱方钙钛矿 JCPDS 86-1518，杂相 Bi₂Fe₄O₉/Bi₂₅FeO₄₀ 随 La 增加而消失）：
    ![XRD patterns of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_1_IKKL6V54.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  ...
  - 图2 FESEM 图像（纳米球→纳米棒形貌演变，Gavg 96.4→168.3 nm）：
    ![FESEM images of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_2_JGXD77K2.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  ...
  - 图3 HRTEM 图像（纳米棒+纳米球共存，Pavg 74.8→127.4 nm）：
    ![TEM images of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_3_JUCADD23.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  ...
  - 图4 介电常数、介电损耗、交流电导率随频率变化（Maxwell-Wagner 极化，弛豫峰 log ω=5.483 与 7.492）：
    ![Dielectric and conductivity spectra](../../raw/figures/Perugu2024morphology/fig_4_IFGXUAMR.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  ...
  - 图5 M-H 磁滞回线及低场放大（弱铁磁/多畴，Ms 13.2→21.5 emu/g）：
    ![M-H loops of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_5_7WVQ8K43.png) -> [[../figures/heterostructures-stacking-multiferroic|多铁与磁电异质结]]
  ...
  - 图6 初始磁导率 μi 随 log ω 变化（双弛豫峰 log ω=4.1 与 5.68，分别归因于铁电/铁磁偶极子）：
    ![Initial permeability spectra](../../raw/figures/Perugu2024morphology/fig_6_PXPLSGQA.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  ...
  - 图7 P-E 电滞回线（"香蕉形"，氧空位导致漏电流大，弱铁电性）：
    ![P-E loops of BLFO nanoparticles](../../raw/figures/Perugu2024morphology/fig_7_VYYYBSDJ.png) -> [[../figures/electronic-devices|电子与突触器件]]
  ...
  - 表1 结构参数（Davg、FWHM、晶格常数、晶胞体积、密度、比表面积）：
    ![Table 1 structural parameters](../../raw/figures/Perugu2024morphology/tab_1_9HPFLKMG.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - 表2 介电参数数据（ε'、ε''、log σ_ac、log σ_dc）：
    ![Table 2 dielectric parameters](../../raw/figures/Perugu2024morphology/tab_2_NSH5KDBB.png) -> [[../figures/electronic-devices|电子与突触器件]]
