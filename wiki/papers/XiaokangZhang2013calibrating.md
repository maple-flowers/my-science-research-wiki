...
## 📊 关键图表
  - ![图1 光纤湿度传感器实物：光纤固定于镂空平板，两侧铜线保护，中段涂覆琼脂糖](../../raw/figures/XiaokangZhang2013calibrating/fig_1_ANUNFWXE.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - ![图2 不同温度（25/28/31/34°C）下 DCSMF 传感器光功率损耗随环境 RH（30–100%）变化曲线，呈非线性、温度-湿度耦合](../../raw/figures/XiaokangZhang2013calibrating/fig_2_L4T2LKTA.png) -> [[../figures/optical-spectra|光学与吸收光谱]]
  - ![图3 30–100% RH、25–34°C 范围内的 701×91 校准矩阵（分辨率 0.1% RH、0.1°C）](../../raw/figures/XiaokangZhang2013calibrating/fig_3_3L3M3YGV.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - ![图4 新拌混凝土 33 小时监测中湿度传感器（A_H）与温度传感器（A_T，放大10倍取整）的原始光功率输出](../../raw/figures/XiaokangZhang2013calibrating/fig_4_PW6KLWFM.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - ![图5 经校准矩阵反演后的混凝土内部 RH（100%→68.9%）与温度（升至 32.3°C 后降至 28°C）演化曲线](../../raw/figures/XiaokangZhang2013calibrating/fig_5_YJ46D44S.png) -> [[../figures/experimental-setups|实验测试与测量装置]]
  - ![公式(1) 饱和水汽压经验公式](../../raw/figures/XiaokangZhang2013calibrating/eq_1_V2WHGBSH.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![公式(2) 列号 k = A_T − 249](../../raw/figures/XiaokangZhang2013calibrating/eq_2_ZEMR3UEV.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  - ![公式(3) RH(%) = (i + 299)/10](../../raw/figures/XiaokangZhang2013calibrating/eq_3_JFFR4H5W.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
