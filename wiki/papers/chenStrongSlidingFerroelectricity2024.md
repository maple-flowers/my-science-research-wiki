...
- **元数据**：陈新峰、丁新凯、缑高阳、曾晓成 et al.，2024，Nano Letters，24(10), 3089-3096，DOI: 10.1021/acs.nanolett.3c04869
- **一句话**：基于第一性原理计算预测可合成的范德华层状晶体 HgX₂（X=Br, I）为新型二维滑动铁电体，其中 HgI₂ 多层具有高达 0.16 μC/cm² 的实验可检测极化、室温可切换性以及层间滑动可控的 Rashba 自旋纹理，可用于二维自旋场效应晶体管。
...
- **新概念/实体建议**：
  ...
  - 实体 `HgBr2`：溴化汞，与 HgI₂ 同构但极化较弱（体相 0.47 μC/cm²，双层 0.02 μC/cm²）。
...
- **关键图表**：
  - ![图0 TOC/摘要图](../../raw/figures/chenStrongSlidingFerroelectricity2024/fig_0_WVFZMG6N.png)
  ...
  - ![图2 双层HgI₂：(a) 平面平均静电势与屏蔽电荷Δρ，(b) 双层极化翻转能垒，(c) ±P态层间差分电荷密度等值面](../../raw/figures/chenStrongSlidingFerroelectricity2024/fig_2_7CPIU55R.png)
  - ![图3 多层HgI₂极化厚度依赖：(a) 3-6层Δρ(z)分区积分，(b) 总极化随层数饱和，(c) 平均层间极化下降](../../raw/figures/chenStrongSlidingFerroelectricity2024/fig_3_JNQI5G5K.png)
  - ![图4 Rashba效应与自旋FET：(a) FE/PE相能带(PBE+SOC)，(b) +P态k_x-k_y自旋纹理，(c) Datta-Das自旋FET器件示意图](../../raw/figures/chenStrongSlidingFerroelectricity2024/fig_4_5NCCX3U9.png)
...
- **可写入wiki的要点**：
  ...
  4. **极化起源为层间电荷重排而非离子位移**：FE-HgI₂ 双层差分电荷密度（等值面 ±4.5×10⁻⁴ e/bohr³）显示层间区域电荷积累/耗尽形成净偶极，方向与总极化平行；而 Hg 离子相对八面体中心的位移 d_Hg = 0.06 Å（双层）方向与总极化相反，对极化作负贡献。单层区域屏蔽电荷积分近乎抵消。这一结论与 β-ZrI₂ 等过渡金属碘化物滑动铁电体一致。
