...
## 📊 关键图表
  - ![图1 液态/非晶态守恒量Ω与势能E随时间变化，验证数值稳定性（液态<5 meV/atom，非晶<1 meV/atom）](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_1_FYHIVIJQ.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图2 金刚石/β-Sn/fcc/bcc/sc 多相 E-V 与 P-V 状态方程，验证赝势（金刚石→β-Sn 相变压计算 75 kbar vs 实验 100 kbar）](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_2_66JCTN4F.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图3 完整热历史：1250 K 液态→分段淬火→600 K 退火→300 K 非晶，温度与势能随时间演化](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_3_5XCMSDMI.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图4 不同温度下均方位移 ⟨r²(t)⟩，扩散随降温急剧冻结](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_4_X5MYLLJD.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图5 液态 Ge（1250 K）的 g(R)、S(Q)（Q≈2k_F 肩峰）、键角分布、DOS（−4.5 eV 赝能隙）](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_5_LFUQ743K.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图6 过冷液态 Ge（750–650 K）：四面体角峰增强，但仍金属性](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_6_4RFP7VPZ.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图7 淬火态非晶 Ge（300 K）：g(R) 第一/二峰分离、109° 键角、费米能级处打开能隙](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_7_AEAIHDCJ.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图8 退火态非晶 Ge：中程有序改善，缺陷态密度下降](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_8_HXHYG2EK.png) -> [[../figures/electronic-bands|电子能带与电子态]]
  ...
  - ![图9 扩散系数 D(T)：液态 D≈1.0×10⁻⁴ cm²/s，T_a 以下降至 6%](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_9_6S6SJV8R.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图10 液态与非晶态速度自相关函数 ψ(t)：液态笼蔽振荡 vs 非晶多频叠加](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_10_GPYHLBTY.png) -> [[../figures/mathematical-models|数学模型与物理公式]]
  ...
  - ![图11 液态 ψ(ω)：30 meV 处 LA 侧峰](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_11_FEJF5ST3.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图12 退火非晶 Ge 振动态密度 G(ω)：TA/LA/LO/TO 四峰与中子非弹性散射实验对比](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_12_9RZ2NNTJ.png) -> [[../figures/electronic-bands|电子能带与电子态]]
  ...
  - ![图13 两种 T=0 构型（慢淬/快淬）g(R) 对比](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_13_K4IFYHDX.png) -> [[../figures/crystal-structures|晶体结构与原子排布]]
  ...
  - ![图16 室温下能隙附近单电子能级随时间涨落，显示缺陷态动态生成/湮灭](../../raw/figures/kresseInitiomoleculardynamicsSimulationLiquidmetalamorphoussemiconductor1994/fig_16_HXTQR8ZG.png) -> [[../figures/electronic-bands|电子能带与电子态]]
