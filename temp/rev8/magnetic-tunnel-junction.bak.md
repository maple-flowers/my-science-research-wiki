---
tags: [concept, spin-orbit-coupling, 2D-materials, magnetoelectric-coupling, strain-engineering, berry-phase, ferroelectric-tunnel-junction, polarization-switching, mlc-stt-ram]
...
本文档围绕 **magnetic-tunnel-junction** 汇集 2 篇论文的证据，覆盖其结构、物性与机制等多方面信息。

## 👵 太奶导读

乖孙，这一条讲的是「magnetic-tunnel-junction」，由多篇论文的证据共同支撑。
这篇论文为它提供了关键证据。
...
- [[../papers/xueEmergingNonvolatileMemories2011]]：为本文档提供核心证据。
