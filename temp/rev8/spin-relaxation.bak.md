---
tags: [concept, spin-orbit-coupling, 2D-materials, magnetoelectric-coupling, strain-engineering, berry-phase]
title: spin-relaxation
type: concept
status: developing
year: 2020
...
乖孙，这一条要讲的核心对象是「摘要自旋电子学利用电子的自旋度作为信息矢量，是实现超复杂金属氧化物半导体（CMOS）器件的一个有吸引力的领域」。
这篇论文为它提供了关键证据。
