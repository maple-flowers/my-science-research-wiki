const content = `---
tags: [density-functional-theory, dftb, nitrogen-doping, mulliken-population, odd-even-oscillation]
title: bamboo-like-N-CNTs
type: entities
status: developing
year: 2021
papers: [Wei2021]
...
研究对象为锯齿型（Zigzag）竹节状氮掺杂碳纳米管，其手性指数为(n,0)，其中n=3–14，共12种不同的管径。

## 👵 太奶导读

乖孙，这一条讲的是「研究对象为锯齿型（Zigzag）竹节状氮掺杂碳纳米管，其手性指数为(n,0)，其中n=3–14，共12种不同的管径」。
...
- [[../entities/DFTB+|DFTB+]]
`;
app.vault.adapter.write('科研Wiki/wiki/entities/bamboo-like-N-CNTs.md', content).then(function(r) { return 'B_ENTITIES_WRITTEN'; });
