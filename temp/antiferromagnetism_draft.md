---
tags: [concept, magnetism, antiferromagnetism]
title: 反铁磁性 / Antiferromagnetism
type: concept
status: mature
domain: [magnetism, strongly-correlated-electron-systems, multiferroics]
mechanism: 相邻自旋通过负交换积分（J<0）反平行排列，宏观净磁化近乎为零；存在奈尔温度 TN，T>TN 呈居里-外斯顺磁，T<TN 磁化率随降温下降
related_concepts: [ferromagnetism, exchange-interaction, heisenberg-model, molecular-field, spin-wave, weak-ferromagnetism, spin-spiral, magnetoelectric-coupling, spin-orbit-coupling, magnetoelastic-coupling]
