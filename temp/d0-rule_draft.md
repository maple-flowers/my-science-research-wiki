...
type: concept
status: mature
domain: [multiferroics, ferroelectricity, magnetism, first-principles]
mechanism: 钙钛矿氧化物中偏心铁电畸变依赖 B 位离子 d⁰ 构型（空 d 轨道利于与 O 2p 杂化），而磁性要求 d 轨道部分占据，两者在过渡金属离子上互斥，是"磁性铁电体稀少"的根源
related_concepts: [ferroelectricity, ferromagnetism, multiferroicity, magnetoelectric-coupling, exchange-interaction, weak-ferromagnetism, stereochemically-active-lone-pair, geometric-ferroelectricity, jahn-teller-distortion, sliding-ferroelectricity]
papers: [hillWhyAreThere2000a, fengFerroelectricityMultiferroicityTwodimensional2020, aiFerroelectricityCoexistedPorbital2022, zhaoOpticalFingerprintsTwodimensional2024, RecentAdvancesGrowth2025, tangMultiferroicityTwodimensionalVan2025]
updated: 2026-08
---
